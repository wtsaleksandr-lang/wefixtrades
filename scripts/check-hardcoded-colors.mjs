...
const ALLOWLIST = new Set([
  ...
  // Brand-locked OAuth buttons. Facebook + Microsoft + Apple brand kits
  // all mandate a fixed background (white for Facebook/Microsoft, solid
  // black with a white glyph + label for Apple's "Sign in with Apple")
  // for their official buttons — themed/inverted variants are not
  // permitted by the brand guidelines and would fail vendor review. The
  // fixed brand interiors also keep the row of social buttons (Google /
  // Facebook / Apple) visually consistent.
  "client/src/components/auth/FacebookSignInButton.tsx",
  "client/src/components/auth/MicrosoftSignInButton.tsx",
  "client/src/components/auth/AppleSignInButton.tsx",
]);
