...
- **Wizard Flow:** A 6-step wizard guides users through calculator creation: Business & Trade Setup, Design Your Calculator, Pricing Logic, Lead Form Builder, Final Test & Preview, and Publish & Share. State is persisted in `localStorage`.
