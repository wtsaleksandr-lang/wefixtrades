...
export const PRODUCT_PAGES: ProductPage[] = [
  ...
  },
  {
    ...
    seoDescription: "Automated website health monitoring, uptime checks, weekly content backups, malware scanning, and CMS patch management. Built for trades businesses. No contracts.",
    category: "growth",
    heroVisualType: "dashboard",
    primaryCTA: { label: "Get Started", href: "#pricing" },
    ...
    highlights: [
      ...
      "Weekly content backups you can restore from — or download and keep",
      "Weekly malware scan against WordPress's own official file checksums",
    ...
    faq: [
      ...
      { q: "What kind of updates are included?", a: "Security patches, plugin and theme updates, and content changes (text, images, hours, pricing). We apply minor and patch updates automatically and hold major version jumps for manual review, so an update never breaks your site unattended." },
      { q: "What exactly do the backups cover?", a: "Every week we capture your site's content — all posts, pages, categories, tags, menus and site settings — and store it encrypted. You can restore any page or post back to your live site in one click, and you can download the whole archive whenever you like; it's plain, readable data that belongs to you. To be straight with you about the limits: it's a content backup, not a full server image. We don't copy your theme's code files or the raw image files (we do record every media item and its address, so restored pages still point at the right images). If you want full server snapshots, that's your web host's job — ask us and we'll tell you how to switch it on." },
      { q: "What does the malware scan actually check?", a: "Two real things, every week. First, we compare your WordPress core files against the official checksums WordPress.org publishes for your exact version — core files are never edited legitimately, so a mismatch is the strongest single sign a site has been broken into. Second, we scan your public pages and scripts for known injection signatures: hidden iframes, base64 loaders, in-browser crypto miners and similar. If we find something, you get the specific file and the specific signature, not a vague warning. It is not a server-side antivirus — we can't read files your site never serves — and we tell you how many URLs and core files each scan covered so you know exactly what \"nothing found\" means." },
  ...
  },
  {
    slug: "adflow",
    name: "AdFlow™",
    shortTagline: "Done-for-you ad campaigns, run by our agency partners",
    seoTitle: "AdFlow™ — Agency-Managed Ad Campaigns for Trades | WeFixTrades",
    seoDescription: `A vetted agency builds and runs your Google and Meta campaigns in your own ad accounts. Monthly reports, transparent pricing, ad spend paid by you directly to the platforms. From ${formatPrice(ADFLOW.tiers[0].price)}/mo.`,
    category: "growth",
    heroVisualType: "dashboard",
    primaryCTA: { label: "Get Started", href: "/wizard" },
    ...
    highlights: [
      "A person runs your ads — Our partner agency handles setup, targeting, creative and ongoing optimisation by hand. There is no self-serve ad tool to learn.",
      "It runs in your own ad accounts — The agency works inside accounts you own and keep. WeFixTrades does not connect to Google Ads or Meta.",
      "Monthly reports, reported by your ads team — Spend, impressions, clicks, leads and cost per lead, reported to us each period and shown in your portal with the date and the person who entered them.",
      "Ad spend funded separately — You pay the ad platforms directly, so their billing stays your source of truth. Our fee covers management only.",
      "Multi-platform reach — Google Ads, Facebook and Instagram campaigns depending on your plan.",
      "No long-term contracts — Cancel anytime. Your ad accounts and their history stay yours.",
    ],
    outcomes: [
      { title: "More leads, faster", desc: "Paid ads deliver leads while SEO and organic strategies build over time." },
      { title: "Reporting that says where it came from", desc: "Each period's figures are labelled as reported by your ads team, with the entry date. Quote requests captured by your WeFixTrades widget are counted by us and shown separately." },
    ...
    howItWorks: [
      ...
      { title: "Monthly reports delivered", desc: "Your ads team reports each period's impressions, clicks, leads, spend and cost per lead. We put those figures in your portal and email, labelled as reported and dated." },
    ],
    bestFor: ["Plumbers", "Electricians", "HVAC Technicians", "Roofers", "Cleaners", "Landscapers", "Painters", "General Contractors"],
    visuals: [
      { title: "Performance Report", desc: "Monthly email report of the figures your ads team reported: leads, spend, cost per lead and click-through rate." },
      { title: "Campaign Management", desc: "Agency handles targeting, creative, bid management, and optimization — by hand, in your ad accounts." },
    ...
    faq: [
      ...
      { q: "How do I see my results?", a: "Two ways, and your portal keeps them separate. Your ads team reports each period's impressions, clicks, leads, spend and cost per lead; we publish those in a monthly email and in your dashboard, labelled as reported and stamped with the date they were entered. Separately, if you use a WeFixTrades quote widget, we count the quote requests it captures from paid-ad traffic ourselves — that figure is measured, not reported." },
      { q: "Does WeFixTrades connect to my Google Ads or Meta account?", a: "No. We do not link to your ad accounts and we never ask for access to them. The agency works inside accounts you own, and the numbers you see in your portal are the ones they report to us. Your ad platform billing remains the source of truth for spend." },
      { q: "Can I pause a campaign from the dashboard?", a: "You can send a pause request from the dashboard and it files a task for your ads team, who apply it in the ad platform by hand. It is not instant and nothing changes on a live campaign until a person actions it — the dashboard says so when you send one." },
  ...
  {
    // Wave 11D D2 — BookFlow standalone $5.89/mo SKU DROPPED. Booking flow
    // is now an included feature of QuoteQuick. Page is kept accessible for
    // SEO (existing inbound links + indexed content) but reframed as "Booking
    // flow — included with QuoteQuick. Free with any QuoteQuick plan." CTAs
    // funnel to /products/quickquotepro instead of a standalone purchase.
    // See WORKSTREAMS/strategy-decisions-locked-2026-05-26.md.
    slug: "bookflow",
    name: "BookFlow",
    shortTagline: "Booking flow — included with QuoteQuick.",
    seoTitle: "BookFlow — Booking Included in QuoteQuick | WeFixTrades",
    seoDescription: "BookFlow is the booking experience inside QuoteQuick. Free with any QuoteQuick plan — customers book directly from your quote widget, AI assistant, or hosted page.",
    category: "core",
    heroVisualType: "dashboard",
    ...
    highlights: [
      ...
      "Mobile-first booking screen — your customers book from their phone in 30 seconds.",
      "Automatic email + SMS confirmations — no calendar app required.",
      "Works with TradeLine — your AI assistant can check availability and book live during a call.",
      "Working hours, services, and buffer time — controlled from your QuoteQuick dashboard.",
    ],
    outcomes: [
      { title: "Why we bundled it", desc: "Trades buyers using QuoteQuick for instant quotes overwhelmingly need booking next. Splitting them into two SKUs added friction with no upside." },
      { title: "One subscription, one login", desc: "QuoteQuick handles instant quotes, lead capture, deposits, and booking from a single dashboard." },
      { title: "Same data, less plumbing", desc: "Customers who quote and book share the same record. No CRM syncing, no duplicate leads." },
    ],
    howItWorks: [
      { title: "Activate QuoteQuick", desc: "Pick a QuoteQuick plan and set up your calculator — booking is unlocked automatically with every plan." },
      { title: "Set your availability", desc: "Working hours, services, and appointment duration — configured in the QuoteQuick dashboard." },
      { title: "Customers self-book", desc: "Visitors get an instant quote, then pick a slot in the same flow. You receive an email + SMS the moment it's booked." },
    ],
    bestFor: ["Plumbers", "Electricians", "HVAC Technicians", "Roofers", "Cleaners", "Landscapers", "Painters", "General Contractors"],
    visuals: [
      { title: "Quote → Book in One Flow", desc: "Customers see their price, then pick a time — no second form, no email back-and-forth." },
      { title: "Appointment Dashboard", desc: "Upcoming bookings, customer details, and quote history in one place inside QuoteQuick." },
      { title: "Instant Notifications", desc: "Email + SMS alerts the moment a new booking is captured." },
    ],
    faq: [
      { q: "Is BookFlow a separate product?", a: "No longer. As of 2026-05-26, the BookFlow capability is bundled inside QuoteQuick — every QuoteQuick plan includes the booking flow at no extra cost." },
      { q: "Do I need a calendar app?", a: "No. Bookings live in your QuoteQuick dashboard. No Google Calendar or Calendly required." },
      { q: "How does this work with TradeLine?", a: "TradeLine reads your QuoteQuick availability and books appointments directly during calls and chats." },
      { q: "How much does it cost?", a: "$0 on top of QuoteQuick. Any QuoteQuick plan — including the free tier — includes the booking flow." },
    ],
    pricingSection: {
      plans: [
        {
          name: "Included with QuoteQuick",
          price: "$0",
          period: " add-on",
          features: [
            "Booking flow included with every QuoteQuick plan",
            "Public booking page with your brand",
            "Working hours, services, and buffer time",
            "Automatic email + SMS confirmations",
            "Customer self-service cancellation",
            "TradeLine integration — AI books live on calls",
          ],
        },
      ],
