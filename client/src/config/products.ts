...
export const PRODUCT_PAGES: ProductPage[] = [
  ...
  },
  {
    ...
    seoDescription: `Done-for-you Google and Meta ad campaigns, managed by our agency partners. Monthly performance reports, transparent pricing, ad spend funded separately. From ${formatPrice(ADFLOW.tiers[0].price)}/mo.`,
    category: "growth",
    heroVisualType: "dashboard",
    primaryCTA: { label: "Get Started", href: "/wizard" },
