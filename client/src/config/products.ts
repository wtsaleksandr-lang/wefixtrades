...
export const PRODUCT_PAGES: ProductPage[] = [
  ...
  },
  {
    slug: "webboost",
    name: "WebBoost\u2122",
    shortTagline: "WebBoost\u2122",
    seoTitle: "WebBoost\u2122 \u2014 Speed + SEO + On-Page Improvements for Trades | WeFixTrades",
    seoDescription: "WebBoost fixes the speed, structure, and SEO issues that quietly cost trades businesses leads every day \u2014 without locking you into a big agency retainer.",
    category: "growth",
    heroVisualType: "dashboard",
    primaryCTA: { label: "Boost My Website", href: "/Wizard" },
    secondaryCTA: { label: "See Pricing", href: "#webboost-pricing" },
    highlights: [
    ...
    howItWorks: [
      { title: "We review your website", desc: "We identify the speed, SEO, and structure issues holding it back" },
      { title: "We fix the important problems", desc: "We improve performance, visibility, and conversion points" },
      { title: "You get a better-performing site", desc: "Faster, cleaner, easier to find, and easier to contact" },
    ],
    bestFor: ["Plumbers", "Electricians", "HVAC Technicians", "Roofers", "Cleaners", "Landscapers", "Contractors"],
    visuals: [
      { title: "Speed Report", desc: "Before and after page speed scores showing measurable improvement." },
      { title: "SEO Audit", desc: "Full technical SEO analysis identifying critical issues." },
      { title: "Performance Dashboard", desc: "Track ongoing improvements to speed and visibility." },
    ],
    faq: [
      { q: "What\u2019s the difference between WebBoost and WebCare?", a: "WebBoost improves your website \u2014 speed, SEO, structure, and conversion. WebCare maintains it over time with ongoing updates, security patches, and monitoring. WebBoost makes it better; WebCare keeps it running." },
      { q: "Why not just use a plugin?", a: "Plugins can help with speed, but they don\u2019t fix SEO structure, on-page issues, or conversion problems. WebBoost addresses all of these together as a complete service." },
      { q: "Is this only for WordPress?", a: "No. WebBoost works on WordPress and most other common website platforms. We assess your site during the initial review and confirm what\u2019s possible." },
      { q: "Will this help me get more calls?", a: "By improving speed, search visibility, and usability, WebBoost gives your site a better chance to convert visitors into real enquiries. It won\u2019t guarantee specific numbers, but it removes the barriers that stop people from contacting you." },
      { q: "How fast do improvements happen?", a: "Speed improvements are usually visible within the first round of work. SEO improvements build over time \u2014 most clients see meaningful changes within 30\u201360 days." },
      { q: "Do I need to understand any technical details?", a: "No. We handle everything and explain what we did and why it matters in plain language. No jargon." },
    ],
    pricingSection: buildPricingSection(WEBBOOST, "No contracts. No bloated agency packages. Just practical improvements."),
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Is SEO included?", a: "Yes. Every SiteLaunch site is built with SEO-ready structure \u2014 proper headings, meta tags, image optimization, and local SEO foundations. For ongoing SEO work, check out WebBoost." },
