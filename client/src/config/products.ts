...
export const PRODUCT_PAGES: ProductPage[] = [
  ...
  },
  {
    ...
    highlights: [
      "Page speed optimization — Faster load times mean fewer bounced visitors and better Google rankings.",
      "Mobile responsiveness — Your site looks and works perfectly on every phone, tablet, and desktop.",
      "SEO structure fixes — Proper headings, meta tags, schema markup, and image alt text so Google can actually find you.",
      "Security hardening — SSL checks, outdated plugin cleanup, and vulnerability patching.",
      "Broken link and 404 cleanup — Every dead link and error page is found and fixed.",
      "Contact form and CTA troubleshooting — Make sure your lead capture forms actually work.",
    ],
    outcomes: [
    ...
    faq: [
      ...
      { q: "What CMS or platforms do you support?", a: "WordPress is our primary focus, but we can work with most platforms including Wix, Squarespace, and Webflow. If you’re not sure, just ask." },
    ],
