...
export const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { label: "QuoteQuick branding", included: "Branded" },
  ...
  },
  {
    id: "starter",
    name: "Starter",
    tagline: "For sole traders. 14-day free trial.",
  ...
  },
  {
    id: "pro",
    name: "Pro",
    tagline: "For growing businesses. 14-day free trial.",
...
export const COMPARISON_ROWS: ComparisonRow[] = [
  ...
  { category: "Branding", feature: "Remove QuoteQuick branding", free: false, starter: true, pro: true, elite: true },
