...
export const PRODUCTS: ProductConfig[] = [
  ...
  { slug: "webboost", name: "WebBoost™", tagline: "Speed + SEO improvements that lift conversions.", primaryCtaLabel: "Start", primaryCtaHref: "/pricing", secondaryCtaLabel: "Run Free Audit", secondaryCtaHref: "/tools/free-audit", icon: "rocket", bullets: ["PageSpeed improvements", "Technical SEO fixes", "Core Web Vitals", "Conversion tuning"] },
  { slug: "webboost-setup", name: "WebBoost Setup", tagline: "One-time speed/SEO upgrade.", primaryCtaLabel: "Start", primaryCtaHref: "/pricing", secondaryCtaLabel: "Run Free Audit", secondaryCtaHref: "/tools/free-audit", icon: "wrench", bullets: ["Audit + plan", "Fix key issues", "Optimize assets", "Re-test"] },
