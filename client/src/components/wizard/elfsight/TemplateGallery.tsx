...
/* Elfsight-style thumbnail pipeline (PNG-first → <TemplateMockup> → category
 * icon) — extracted to the shared `<TemplateThumbnail>` so the marketing
 * /templates cards render the SAME preview. This gallery passes its shared
 * `missing` Set (controlled mode) so PNG-failure state survives list
 * re-renders, exactly as before the extraction. */
