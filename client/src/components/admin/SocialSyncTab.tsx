      ...
      <Card className="p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button size="sm" className="bg-brand-blue hover:bg-brand-blue-600" onClick={() => generateWeek.mutate()} disabled={generateWeek.isPending || !profile.enabled}>
              ...
              {!rlEditing ? (
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <Button size="sm" className="h-7 text-xs bg-brand-blue hover:bg-brand-blue-600"
      ...
      <div className="flex items-center justify-between mb-2">
        ...
        <div className="flex items-center gap-2">
          {state === "awaiting_review" && (
            <Button size="sm" className="h-7 text-xs bg-brand-blue hover:bg-brand-blue-600" onClick={onGenerateWeek} disabled={isGenerating}>
  ...
  return (
    <Card className="p-4 mt-3 border-blue-200 bg-blue-50/30">
      ...
      <div className="flex justify-end gap-2 mt-4">
        ...
        <Button size="sm" className="bg-brand-blue hover:bg-brand-blue-600" onClick={handleSave} disabled={isPending}>
