...
const SECTIONS: SitemapSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { href: "/tools/nap-checker", label: "NAP Consistency Checker" },
      { href: "/tools/gbp-post-generator", label: "GBP Post Generator" },
      { href: "/tools/review-response-generator", label: "Review Response Generator" },
  ...
  },
  {
    ...
    entries: [
      ...
      { href: "/templates", label: "Calculator Templates" },
