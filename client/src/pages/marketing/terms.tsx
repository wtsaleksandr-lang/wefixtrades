 ...
 * Includes a mobile-app / app-store section with Apple's required EULA
 * acknowledgements. Have an attorney review before fundraising, enterprise
 * contracts, international expansion, or any litigation threat.
 *
...
const TOC: TocItem[] = [
  { id: "who", label: "1. Who can use the Service" },
  ...
  { id: "deployed-agents", label: "7b. AI agents you deploy" },
  { id: "thirdparty", label: "8. Third-party services" },
  { id: "appstore", label: "8a. Mobile app & app stores" },
  { id: "content", label: "9. Your content & data" },
  { id: "acceptable", label: "10. Acceptable use" },
  { id: "ip", label: "11. Intellectual property" },
  { id: "warranty", label: "12. Warranty disclaimers" },
...
export default function TermsPage() {
  return (
    <LegalShell
      ...
      metaDescription="The terms governing your use of WeFixTrades products, services, and mobile app."
      canonical="/terms"
      toc={TOC}
    >
      ...
      <LegalSection id="who" title="1. Who we are and who can use the Service">
        <p>
      ...
      <LegalSection id="services" title="3. Services we offer">
        <p>
      ...
      <LegalSection id="payments" title="3a. Payments you collect from your own customers">
        <p>
          Some of our tools — most notably <strong>QuoteQuick</strong> — let you collect
          payments, deposits, or quote-acceptance fees directly from your own customers. The
          fees you charge <em>your</em> customers are separate from the fees you pay
          <em> us</em> for the Service (section 4). When you use our tools to take payment from
          your customers:
        </p>
        <ul style={ul}>
          <li><strong>You are the merchant of record.</strong> You set your own prices, deposit amounts, service descriptions, and payment terms, and the contract for those goods or services is between you and your customer — not with WeFixTrades.</li>
          <li><strong>You own the customer relationship.</strong> You are solely responsible for fulfilment and for your customers' refunds, chargebacks, disputes, cancellations, and for any applicable sales tax, VAT, or GST on what you sell.</li>
          <li><strong>Processing runs through a third party.</strong> Payments are handled by a payment processor we integrate (e.g. Stripe). Your acceptance and use of that processing is also subject to the processor's own terms (for example the Stripe Services Agreement and Connected Account Agreement), and you are responsible for keeping your processor account in good standing.</li>
          <li><strong>We are the software provider, not a payment intermediary.</strong> WeFixTrades enables the transaction; we are not a party to the contract between you and your customer, we do not act as merchant or hold funds on your behalf, and we are not responsible for the goods or services you sell or for any dispute between you and your customer.</li>
          <li><strong>Lawful use only.</strong> You must not use our payment-enabled tools for any business or practice prohibited by the payment processor or by law, including deceptive pricing or prohibited categories.</li>
        </ul>
      </LegalSection>

      <LegalSection id="fees" title="4. Fees, billing, and taxes">
        <p>
      ...
      <LegalSection id="recording" title="7a. Call recording, voice AI, and consent">
        <p>
          TradeLine and our other voice products use AI to answer, place, record, and
          transcribe phone calls and to send SMS on your behalf through providers such as
          Vapi, Twilio, ElevenLabs, and Deepgram. Call recording and messaging are powerful
          but heavily regulated, and you are responsible for using them lawfully:
        </p>
        <ul style={ul}>
          <li><strong>Consent to record.</strong> Recording-consent rules vary — many US states and other countries require one-party or all-party consent, and some require a spoken disclosure at the start of the call. You are responsible for determining which laws apply to you and your callers and for enabling the appropriate disclosures.</li>
          <li><strong>AI / automated-system disclosure.</strong> Some jurisdictions require you to disclose that a caller is interacting with an automated or AI system. Where that applies to you, you are responsible for ensuring the disclosure is made; we provide configurable greeting and disclosure settings to help.</li>
          <li><strong>SMS consent.</strong> You must obtain the necessary prior express consent before texting your customers, honour opt-outs (e.g. STOP), and comply with TCPA, CAN-SPAM, CASL, and carrier / A2P 10DLC requirements.</li>
          <li><strong>You own what the assistant says.</strong> You are responsible for what your AI assistant says and does on your behalf and for keeping the business information it relies on accurate. We build approval gates and configurable disclosures, but final responsibility rests with you.</li>
        </ul>
      </LegalSection>

      <LegalSection id="deployed-agents" title="7b. AI agents and customer portals you deploy">
        <p>
          Where you configure and deploy AI assistants, chat agents, or customer-facing
          portals built on our Service to interact with your own customers:
        </p>
        <ul style={ul}>
          <li><strong>You are responsible for their conduct.</strong> The content, accuracy, and behaviour of those agents toward your end users — and any representations they make about your business, pricing, or availability — are your responsibility.</li>
          <li><strong>You provide the end-user notices.</strong> You are responsible for giving your end users any notices, terms, and privacy disclosures their interaction with you requires. Under our <a href="/privacy" style={{ color: mkt.accent }}>Privacy Policy</a> you are the data controller for that end-user data and we act as your processor.</li>
          <li><strong>Prohibited uses.</strong> You must not configure agents to provide regulated professional advice (legal, medical, financial) where you are not licensed to do so, or to engage in unlawful, deceptive, or harassing conduct.</li>
        </ul>
      </LegalSection>

      <LegalSection id="thirdparty" title="8. Third-party services">
        <p>
      ...
      <LegalSection id="appstore" title="8a. Mobile app and app stores">
        <p>
          WeFixTrades is also distributed as a mobile application through the
          <strong> Apple App Store</strong> and <strong>Google Play</strong>. When you
          download or use the app, you also agree to the applicable store's terms —
          including Apple's Licensed Application End User License Agreement (or Apple's
          standard EULA) and Google Play's Terms of Service.
        </p>
        <p style={{ marginTop: 12 }}>
          To the extent required by Apple, you acknowledge that: (a) these Terms are
          concluded between you and WeFixTrades only, not Apple, and Apple is not
          responsible for the app or its content; (b) Apple has no obligation to furnish
          maintenance or support for the app; (c) WeFixTrades, not Apple, is responsible
          for addressing any claims relating to the app; and (d) Apple and its subsidiaries
          are third-party beneficiaries of these Terms and may enforce them against you.
          The app stores are not responsible for the Service or its content.
        </p>
      </LegalSection>

      <LegalSection id="content" title="9. Your content and data">
        <p>
        ...
        <p>
          We process personal data on your behalf in accordance with our{" "}
          <a href="/privacy" style={{ color: mkt.accent }}>Privacy Policy</a>. For customers
          subject to GDPR, we act as a data processor where applicable; a data processing
      ...
      <LegalSection id="acceptable" title="10. Acceptable use">
        <p>
      ...
      <LegalSection id="warranty" title="12. Warranty disclaimers">
        <p>
