...
const config: FeaturePageConfig = {
  ...
  demo: {
    ...
    description: "Most quote tools force you into a fixed template. QuickQuotePro gives you 10 formula families — from simple hourly rates to complex area-based pricing with tiered ranges, addons, and conditional logic. Then AI validates your configuration before it goes live.",
    bullets: [
