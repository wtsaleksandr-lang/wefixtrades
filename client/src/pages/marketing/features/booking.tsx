...
const config: FeaturePageConfig = {
  ...
  faqs: [
    { q: "How does Stripe Connect work?", a: "You connect your Stripe account (free) to QuickQuotePro. Deposits are charged directly by your business — we never hold your funds. Stripe's standard processing fee (1.7–2.9% + 30¢) applies." },
