  ...
  return (
    <MarketingLayout>
      <div data-testid="pricing-page" style={{ overflowX: "hidden" }}>
        ...
        >
          <div style={{ position: "absolute", top: -80, right: -80, width: 420, height: 420, borderRadius: "50%", background: "rgba(13,60,252,0.08)", pointerEvents: "none" }} />
          <div style={{ position: "absolute", bottom: -60, left: -60, width: 320, height: 320, borderRadius: "50%", background: "rgba(13,60,252,0.07)", pointerEvents: "none" }} />
