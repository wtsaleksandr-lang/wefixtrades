...
import { HEADING_FONT, BODY_FONT, GLASS, GLOW_CYAN, sectionHeading, sectionSub, SECTION_PAD, MAX_W } from "./styles";
import { QUOTEQUICK } from "@/config/pricing";

const PLANS = QUOTEQUICK.tiers.map((t) => ({
  name: t.name,
  price: t.price,
  badge: t.badge || null,
  features: t.features,
    ...
    >
      <div style={MAX_W}>
        <div style={{ textAlign: "center", marginBottom: 48 }} data-reveal="fade-up">
          ...
          <p style={sectionSub}>
            Pick the plan that fits your business. No hidden fees, no contracts.
          </p>
        </div>
            ...
            >
              ...
              >
                {plan.features.map((f) => (
                  ...
                  >
                    <Check size={16} color={mkt.accent} strokeWidth={2.5} style={{ flexShrink: 0, marginTop: 2 }} />
                    {f}
                  </li>
                ))}
              </ul>
