      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px 60px" }}>
        ...
        {activeTab === "faq" && <section id="faq" style={{ marginTop: 40 }}>
          ...
          <div style={{ marginTop: 24, display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <PlanAccordion q="Do you offer a trial or money-back guarantee?" a="QuoteQuick Pro has a 14-day free trial — no credit card required. Every other paid recurring service (TradeLine, MapGuard, ReputationShield, SocialSync, RankFlow, WebCare) ships with a 30-day money-back guarantee: email us within 30 days of your first charge and we refund it in full." />
            <PlanAccordion q="Do I need technical skills?" a="No. Setup is guided. For done-for-you services (MapGuard, SocialSync, RankFlow, AdFlow), our team handles the technical work and you approve the outcomes." />
            ...
            <PlanAccordion q="What about AdFlow ad spend — is that refundable?" a="The management fee follows the 30-day guarantee. The ad spend itself (what we deploy to Google or Meta on your behalf) is never refundable — once campaigns launch, that money is with the platform, not with us. This is noted at checkout." />
          </div>
        </section>}
      </div>
    </MarketingLayout>
