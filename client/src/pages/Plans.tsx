        ...
        return (
          <button
            ...
            style={{
              ...
              fontSize: 14,
              fontWeight: 700,
              border: active ? "1px solid #0d3cfc" : "1px solid rgba(0,0,0,0.10)",
              cursor: "pointer",
              transition: "all 0.18s ease",
              background: active ? "#0d3cfc" : "rgba(255,255,255,0.60)",
              color: active ? "#FFFFFF" : "rgba(0,0,0,0.65)",
            }}
          >
            {t.label}
        ...
        <div style={{ position: "absolute", top: -12, left: 24 }}>
          <span
            ...
            style={{
              ...
              fontSize: 12,
              fontWeight: 800,
              boxShadow: "0 10px 26px rgba(13,60,252,0.35)",
            }}
          >
            {badge}
          </span>
        ...
        <ul style={{ marginTop: 12, listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: 8 }}>
          {bullets.map((b, i) => (
            <li key={i} style={{ display: "flex", gap: 8, fontSize: 14, color: "rgba(0,0,0,0.60)" }}>
              <span style={{ marginTop: 6, width: 8, height: 8, borderRadius: "50%", background: "rgba(13,60,252,0.55)", flexShrink: 0 }} />
              <span>{b}</span>
            </li>
          ))}
        </ul>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "40px 24px 60px" }}>
        ...
        {activeTab === "faq" && <section id="faq" style={{ marginTop: 40 }}>
          ...
          <div style={{ marginTop: 24, display: "flex", flexDirection: "column", gap: 12 }}>
            <PlanAccordion q="Is there a contract?" a="No contracts. Monthly plans cancel any time. Annual plans are charged once a year — cancel mid-year and you keep access until the period ends, but we don't pro-rate refunds." />
            <PlanAccordion q="Can I cancel anytime?" a="Yes. Any plan can be paused or canceled from your portal. No phone calls, no retention teams." />
            <PlanAccordion q="Do you offer a trial or money-back guarantee?" a="QuoteQuick has a 14-day free trial — no credit card required. Every other paid recurring service (TradeLine, MapGuard, ReputationShield, SocialSync, RankFlow, WebCare) ships with a 30-day money-back guarantee: email us within 30 days of your first charge and we refund it in full." />
            <PlanAccordion q="Do I need technical skills?" a="No. Setup is guided. For done-for-you services (MapGuard, SocialSync, RankFlow), our team handles the technical work and you approve the outcomes." />
            <PlanAccordion q="Can I upgrade/downgrade anytime?" a="Yes. You can switch plans any time from your portal. Upgrades take effect immediately, downgrades at the next billing cycle." />
            <PlanAccordion q="Do you support both Canada and USA?" a="Yes. We support service businesses in Canada and the USA." />
            <PlanAccordion q="How fast can I go live?" a="QuoteQuick and TradeLine can be live within 30 minutes. MapGuard and ReputationShield typically go live in 2-5 business days. SiteLaunch custom builds take 5-7 days; SiteLaunch templates are usually 48-72 hours." />
