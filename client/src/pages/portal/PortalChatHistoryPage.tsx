  ...
  return (
    <PortalLayout>
      <div className="max-w-3xl space-y-4">
        ...
        {error && (
          <Card className="p-4 border-red-200 bg-red-50 text-red-700 dark:border-red-800/60 dark:bg-red-950/40 dark:text-red-300 text-sm">
            {(error as Error).message}
          </Card>
        )}

        {!isLoading && !error && messages.length === 0 && (
          <Card className="p-8 text-center text-sm text-muted-foreground" data-testid="chat-history-empty">
            <MessageSquare className="w-8 h-8 text-muted-foreground/50 mx-auto mb-3" aria-hidden="true" />
