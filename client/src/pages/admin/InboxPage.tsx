...
export default function InboxPage() {
  ...
  return (
    <AdminLayout pageContext={{
      ...
      topTasks: (tasks ?? []).slice(0, 8).map(t => ({ title: t.title, status: t.status, priority: t.priority, waiting_on: t.waiting_on, handled_by: t.handled_by, automation_status: t.automation_status, next_action: t.next_action })),
    }}>
