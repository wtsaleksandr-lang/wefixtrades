...
import { Plus, RefreshCw, Users, Send, CheckCircle, AlertCircle } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              <label className="text-xs font-medium text-gray-600">External Campaign ID</label>
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200 sticky top-0">
              <tr>
                ...
                <th className="px-3 py-2.5 text-left text-xs font-medium text-gray-500">Sync</th>
              </tr>
            </thead>
