...
const PRODUCT_GROUPS: ProductGroup[] = [
    ...
    tiers: [
      {
        ...
        priceOneTime: 1197,
        cadence: "one-time",
        includes: ["5\u20137 page website", "Mobile optimization", "Speed optimization", "Basic SEO", "Contact forms", "QuoteQuick embed", "BONUS: 14-day free trial of TradeLine Starter + QuoteQuick Pro"],
        highlighted: true,
        badge: "All Inclusive",
      },
    ],
  },
  {
    id: "tradeline",
    family: "TradeLine\u2122",
    description: "AI answering, SMS replies, missed call auto-response & follow-ups.",
    tiers: [
      {
        name: "Starter",
        priceMonthly: 97,
        priceOneTime: null,
        cadence: "/mo",
        includes: ["200 minutes included", "AI answering", "SMS replies", "Missed call auto-response", "Follow-ups"],
      },
      {
        name: "Pro",
        priceMonthly: 197,
        priceOneTime: null,
        cadence: "/mo",
        includes: ["600 minutes included", "AI answering", "SMS replies", "Missed call auto-response", "Follow-ups"],
        highlighted: true,
        badge: "Most Popular",
      },
      {
        ...
        priceOneTime: null,
        cadence: "/mo",
        includes: ["1500 minutes included", "AI answering", "SMS replies", "Missed call auto-response", "Follow-ups"],
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        priceOneTime: null,
        cadence: "/mo",
        includes: ["Basic calculator", "Lead capture", "Hosted quote page", "Embed on your site"],
      },
      {
        name: "Pro",
        priceMonthly: 79,
        priceOneTime: null,
        cadence: "/mo",
        includes: ["Advanced logic", "Custom styling", "Booking integration", "Lead capture + storage", "Analytics dashboard"],
        highlighted: true,
        badge: "Most Popular",
      },
    ],
    ...
    tiers: [
      {
        ...
        priceOneTime: 349,
        cadence: "one-time",
        includes: ["Full PageSpeed audit", "Core Web Vitals fixes", "Image & asset optimisation", "Before/after speed report"],
      },
      {
        name: "Basic",
        priceMonthly: 79,
        priceOneTime: null,
        cadence: "/mo",
        includes: ["Monitoring", "Updates", "Monthly performance report"],
      },
      {
        name: "Pro",
        priceMonthly: 129,
        priceOneTime: null,
        cadence: "/mo",
        includes: ["SEO fixes", "Optimization", "Core Web Vitals monitoring", "Monthly reports"],
        highlighted: true,
        badge: "Popular",
      },
    ],
    ...
    tiers: [
      {
        ...
        priceOneTime: 397,
        cadence: "one-time",
        includes: ["Full profile audit & rebuild", "Category & service area optimisation", "Description & keyword tuning", "Photos & posts launch plan"],
      },
      {
        name: "Basic",
        priceMonthly: 99,
        priceOneTime: null,
        cadence: "/mo",
        includes: ["2 posts/month", "Profile monitoring", "Monthly ranking report"],
      },
      {
        name: "Pro",
        priceMonthly: 149,
        priceOneTime: null,
        cadence: "/mo",
        includes: ["4 posts/month", "Review responses", "Optimization", "Competitor analysis"],
        highlighted: true,
        badge: "Popular",
      },
    ],
    ...
    tiers: [
      {
        ...
        priceOneTime: null,
        cadence: "/mo",
        includes: ["Review monitoring", "Google + Facebook", "Review request emails", "Monthly report"],
      },
      {
        name: "Pro",
        priceMonthly: 129,
        priceOneTime: null,
        cadence: "/mo",
        includes: ["All platforms", "SMS + email requests", "AI response templates", "Negative review alerts", "Website review widget"],
        highlighted: true,
        badge: "Most Popular",
      },
      {
        ...
        priceOneTime: null,
        cadence: "/mo",
        includes: ["All Pro features", "Priority support", "Advanced analytics", "Custom escalation rules"],
      },
    ],
  },
  {
    ...
    tiers: [
      {
        ...
        priceOneTime: null,
        cadence: "/mo",
        includes: ["Content creation & scheduling", "1 platform", "Branded templates", "Monthly report"],
      },
      {
        name: "Growth",
        priceMonthly: 149,
        priceOneTime: null,
        cadence: "/mo",
        includes: ["2 platforms", "Lead-gen campaigns", "Stories + Reels", "Engagement management"],
        highlighted: true,
        badge: "Most Popular",
      },
      {
        ...
        priceOneTime: null,
        cadence: "/mo",
        includes: ["Full management", "All platforms", "Lead-gen campaigns", "Bi-weekly reports"],
      },
    ],
  },
];
