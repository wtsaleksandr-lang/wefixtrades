...
**Last updated:** 2026-06-10. Originally authored 2026-05-08 on branch
`claude/outreach-engine`; salvaged to `main` during the 2026-06-10 branch
cleanup (source branch archived as tag `archive/claude/outreach-engine`).
