...
export const bookflowAppointments = pgTable("bookflow_appointments", {
  ...
  // Wave 80 — partial indexes backing the new BookFlow SMS lifecycle
  // workers. The actual partial-WHERE clause lives in migrations/0070;
  // the names are declared here so check-schema-drift sees them.
