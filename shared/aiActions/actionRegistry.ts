...
export const AI_ACTIONS: AIAction[] = [
  ...
  /* ─── AdFlow (portal) ───────────────────────────────────────────── */
  {
    ...
    description: "Ask your ads team to pause this campaign. Applied manually — not instantly. Already-spent budget isn't refunded.",
    icon: "Pause",
    confirmationLevel: "hard",
    destructive: true,
  },
  {
    ...
    description: "Ask your ads team to resume this campaign. Applied manually — not instantly.",
    icon: "Play",
    confirmationLevel: "soft",
  },
  {
    ...
    description: "Ask your ads team to pause the campaign underperforming over the last 7 days.",
    icon: "Pause",
    confirmationLevel: "hard",
    destructive: true,
  },
  {
    ...
    context: "portal",
    label: "Boost winner",
    description: "Ask your ads team to shift budget toward the highest-grade campaign. We confirm the new spend with you first.",
    icon: "TrendingUp",
    confirmationLevel: "hard",
  },
  {
  ...
  },
  {
    ...
    description: "Ask your ads team to scope duplicating this campaign onto a second platform.",
    icon: "Layers",
    confirmationLevel: "hard",
  },
  {
    ...
    description: "Approve the anomaly-triggered pause. Your ads team applies it manually as a priority.",
    icon: "ShieldCheck",
    confirmationLevel: "hard",
    destructive: true,
  },
  {
    ...
    description: "Approve the anomaly-triggered budget increase. We confirm the amount with you before applying it.",
    icon: "TrendingUp",
    confirmationLevel: "hard",
  },
  {
