  ...
  /* ── 16. Move-in / move-out cleaning ── */
  {
    ...
    fields: [
      ...
      { id: 'condition', name: 'Move-Out Condition', label: 'How is the home being left?', type: 'radio',
        ...
        options: [
          { ...optImg('Fairly clean', 0, 'https://images.unsplash.com/photo-1484154218962-a197022b5858?w=300&h=300&fit=crop'),
            description: 'Lightly lived-in — just needs the landlord-checklist reset.' },
          { ...optImg('Average', 80, 'https://images.unsplash.com/photo-1556909212-d5b604d0c90d?w=300&h=300&fit=crop'),
            description: 'Normal wear — grease, dust and bathroom buildup to cut through.' },
          { ...optImg('Rough', 220, 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=300&h=300&fit=crop'),
  ...
  /* ── 17. Office / commercial cleaning ── */
  {
    ...
    fields: [
      ...
      { id: 'frequency', name: 'Frequency', label: 'How often do you want service?', type: 'radio',
        ...
        options: [
          { ...optImg('Daily — 5x / week', 1.0, 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=300&h=300&fit=crop'),
            description: 'A spotless office every business day — best per-visit rate.' },
          { ...optImg('Three times a week', 0.85, 'https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?w=300&h=300&fit=crop'),
            description: 'High-traffic offices that need regular upkeep.' },
          { ...optImg('Weekly', 0.65, 'https://images.unsplash.com/photo-1556911220-bff31c812dba?w=300&h=300&fit=crop'),
            description: 'A thorough once-a-week reset for smaller teams.' },
          { ...optImg('Bi-weekly', 0.55, 'https://images.unsplash.com/photo-1556911220-e15b29be8c8f?w=300&h=300&fit=crop'),
  ...
  /* ── 18. Window cleaning ── */
  {
    ...
    fields: [
      ...
      { id: 'stories', name: 'Stories', label: 'Building height', type: 'radio',
        ...
        options: [
          { ...optImg('Single-story', 0, 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=300&h=300&fit=crop'),
            description: 'Ground-floor reach with pure-water poles — fastest clean.' },
          { ...optImg('Two-story', 4, 'https://images.unsplash.com/photo-1503594384566-461fe158e797?w=300&h=300&fit=crop'),
            description: 'Upper windows reached with extension poles from the ground.' },
          { ...optImg('Three+ story', 9, 'https://images.unsplash.com/photo-1513694203232-719a280e022f?w=300&h=300&fit=crop'),
  ...
  /* ── 21. Basement finishing ── */
  {
    ...
    fields: [
      ...
      { id: 'ceiling', name: 'Ceiling', label: 'Ceiling treatment', type: 'radio',
        ...
        options: [
          { ...optImg('Exposed (painted)', 8, 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=300&h=300&fit=crop'),
            description: 'Industrial look — joists and ducts painted out. Cheapest, full access overhead.' },
          { ...optImg('Drop tile', 14, 'https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?w=300&h=300&fit=crop'),
            description: 'Suspended grid that hides utilities but lifts out for plumbing access.' },
          { ...optImg('Full drywall', 22, 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=300&h=300&fit=crop'),
     ...
     the deep per-template Playwright spec (PR #372). */
  {
    ...
    fields: [
      ...
      { id: 'coats', name: 'Coats', label: 'Number of paint coats', type: 'radio',
        ...
        options: [
          { ...optImg('One coat', 1.0, 'https://images.unsplash.com/photo-1562259949-e8e7689d7828?w=300&h=300&fit=crop'),
            description: 'A refresh over a similar color — lightest coverage.' },
          { ...optImg('Two coats — recommended', 1.6, 'https://images.unsplash.com/photo-1618220179428-22790b461013?w=300&h=300&fit=crop'),
  ...
  /* ── 26. EV charger installation ── */
  {
    ...
    fields: [
      ...
      { id: 'charger_level', name: 'Charger Level', label: 'Charger level', type: 'radio',
        ...
        options: [
          { ...optImg('Level 1 (120V)', 350, 'https://images.unsplash.com/photo-1593941707882-a5bba14938c7?w=300&h=300&fit=crop'),
            description: 'Plugs into a normal outlet — slow, fine for plug-in hybrids and low daily miles.' },
          { ...optImg('Level 2 (240V, 32A)', 950, 'https://images.unsplash.com/photo-1647500666543-8b0bdc3eb6c5?w=300&h=300&fit=crop'),
            description: 'The popular home setup — a full overnight charge for most EVs.' },
          { ...optImg('Level 2 (240V, 50A)', 1250, 'https://images.unsplash.com/photo-1558389186-438424b00a6b?w=300&h=300&fit=crop'),
  ...
  /* ── 28. Concrete driveway replacement ── */
  {
    ...
    fields: [
      ...
      { id: 'finish', name: 'Finish', label: 'Concrete finish type', type: 'radio',
        ...
        options: [
          { ...optImg('Standard broom', 7, 'https://images.unsplash.com/photo-1600585152220-90363fe7e115?w=300&h=300&fit=crop'),
            description: 'Classic textured grey finish — durable and budget-friendly.' },
          { ...optImg('Exposed aggregate', 11, 'https://images.unsplash.com/photo-1597047084897-51e81819a499?w=300&h=300&fit=crop'),
            description: 'Pebbled, slip-resistant surface with a natural-stone look.' },
          { ...optImg('Stamped pattern', 14, 'https://images.unsplash.com/photo-1604014237800-1c9102c219da?w=300&h=300&fit=crop'),
            description: 'Patterned concrete that mimics brick, slate or cobblestone.' },
          { ...optImg('Colored + stamped', 18, 'https://images.unsplash.com/photo-1581858726788-75bc0f6a952d?w=300&h=300&fit=crop'),
  ...
  /* ── 29. Tree service ── */
  {
    ...
    fields: [
      ...
      { id: 'service', name: 'Service', label: 'What service do you need?', type: 'radio',
        ...
        options: [
          { ...optImg('Trim / prune', 200, 'https://images.unsplash.com/photo-1416331108676-a22ccb276e35?w=300&h=300&fit=crop'),
            description: 'Shaping, deadwood and canopy thinning to keep a tree healthy.' },
          { ...optImg('Removal — no stump', 600, 'https://images.unsplash.com/photo-1592417817098-8fd3d9eb14a5?w=300&h=300&fit=crop'),
            description: 'Full take-down, leaving the stump flush to the ground.' },
          { ...optImg('Removal + stump grind', 850, 'https://images.unsplash.com/photo-1558904541-efa843a96f01?w=300&h=300&fit=crop'),
  ...
  /* ── 31. Mobile car detailing ── */
  {
    ...
    fields: [
      ...
      { id: 'vehicle', name: 'Vehicle Size', label: 'Vehicle size', type: 'radio',
        ...
        options: [
          { ...optImg('Sedan / coupe', 1.0, 'https://images.unsplash.com/photo-1503376780353-7e6692767b70?w=300&h=300&fit=crop'),
            description: 'Standard 4-door or 2-door car — the baseline rate.' },
          { ...optImg('SUV / mid-size', 1.25, 'https://images.unsplash.com/photo-1519641471654-76ce0107ad1b?w=300&h=300&fit=crop'),
            description: 'Crossover or mid-size SUV — a bit more surface and interior.' },
          { ...optImg('Truck / full-size SUV', 1.5, 'https://images.unsplash.com/photo-1605559424843-9e4c228bf1c2?w=300&h=300&fit=crop'),
            description: 'Pickup or large SUV — more glass, panels and cab to detail.' },
          { ...optImg('Van / 3-row SUV', 1.75, 'https://images.unsplash.com/photo-1559416523-140ddc3d238c?w=300&h=300&fit=crop'),
  ...
  /* ── 32. Locksmith service ── */
  {
    ...
    fields: [
      ...
      { id: 'service', name: 'Service', label: 'What do you need?', type: 'radio',
        ...
        options: [
          { ...optImg('Home lockout', 95, 'https://images.unsplash.com/photo-1558002038-1055907df827?w=300&h=300&fit=crop'),
            description: 'Locked out of the house — non-destructive entry, no damage to your door.' },
          { ...optImg('Car lockout', 110, 'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=300&h=300&fit=crop'),
            description: 'Keys locked in the car — fast roadside entry.' },
          { ...optImg('Rekey lock', 65, 'https://images.unsplash.com/photo-1582139329536-e7284fece509?w=300&h=300&fit=crop'),
            description: 'Keep your hardware, change the key — ideal after a move.' },
          { ...optImg('New deadbolt install', 180, 'https://images.unsplash.com/photo-1622372738946-62e02505feb3?w=300&h=300&fit=crop'),
            description: 'Add a fresh, high-security deadbolt to a door.' },
          { ...optImg('Smart lock install', 280, 'https://images.unsplash.com/photo-1558002038-1055907df827?w=300&h=300&fit=crop'),
            description: 'Keypad or app-controlled lock fitted and set up.' },
          { ...optImg('Key duplication', 25, 'https://images.unsplash.com/photo-1582139329536-e7284fece509?w=300&h=300&fit=crop'),
  ...
  /* ── 33. Water damage restoration ── */
  {
    ...
    fields: [
      ...
      { id: 'severity', name: 'Severity', label: 'Water category', type: 'radio',
        ...
        options: [
          { ...optImg('Class 1 — clean, minor', 1.0, 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=300&h=300&fit=crop'),
            description: 'Clean-water leak from a supply line or rain — fastest to dry out.' },
          { ...optImg('Class 2 — gray water', 1.4, 'https://images.unsplash.com/photo-1589939705384-5185137a7f0f?w=300&h=300&fit=crop'),
            description: 'Appliance or washing-machine overflow with some contamination.' },
          { ...optImg('Class 3 — extensive saturation', 2.0, 'https://images.unsplash.com/photo-1581094794329-c8112a89af12?w=300&h=300&fit=crop'),
            description: 'Water from above soaking walls, ceilings and floors throughout.' },
          { ...optImg('Class 4 — sewage / hazardous', 2.8, 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=300&h=300&fit=crop'),
  ...
  /* ── 34. Emergency HVAC repair ── */
  {
    ...
    fields: [
      ...
      { id: 'system', name: 'System', label: 'Which system is failing?', type: 'radio',
        ...
        options: [
          { ...optImg('AC / cooling', 0, 'https://images.unsplash.com/photo-1558002038-1055907df827?w=300&h=300&fit=crop'),
            description: 'Central air or condenser not cooling the house.' },
          { ...optImg('Furnace / heating', 0, 'https://images.unsplash.com/photo-1581092160562-40aa08e78837?w=300&h=300&fit=crop'),
            description: 'Gas or electric furnace not producing heat.' },
          { ...optImg('Heat pump', 30, 'https://images.unsplash.com/photo-1615870216519-2f9fa575fa5c?w=300&h=300&fit=crop'),
            description: 'All-in-one heat-and-cool system acting up.' },
          { ...optImg('Mini-split', 45, 'https://images.unsplash.com/photo-1558036117-15d82a90b9b1?w=300&h=300&fit=crop'),
  ...
  /* ── 36. Photography package ── */
  {
    ...
    fields: [
      ...
      { id: 'event_type', name: 'Event Type', label: 'What\'s the shoot for?', type: 'radio',
        ...
        options: [
          { ...optImg('Portrait session', 250, 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=300&h=300&fit=crop'),
            description: 'Headshots or personal portraits — studio or on-location.' },
          { ...optImg('Family / lifestyle', 380, 'https://images.unsplash.com/photo-1511895426328-dc8714191300?w=300&h=300&fit=crop'),
            description: 'Relaxed, candid sessions for families and couples.' },
          { ...optImg('Corporate event', 850, 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=300&h=300&fit=crop'),
            description: 'Conferences, launches and team events with fast turnaround.' },
          { ...optImg('Wedding', 2400, 'https://images.unsplash.com/photo-1519741497674-611481863552?w=300&h=300&fit=crop'),
            description: 'Full-day coverage of your ceremony and reception.' },
          { ...optImg('Real estate listing', 320, 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=300&h=300&fit=crop'),
            description: 'Bright, wide listing photos that sell the property.' },
          { ...optImg('Product / e-commerce', 480, 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=300&h=300&fit=crop'),
  ...
  /* ── 39. Solar panel installation ── */
  {
    ...
    fields: [
      ...
      { id: 'roof_type', name: 'Roof Type', label: 'Roof type', type: 'radio',
        ...
        options: [
          { ...optImg('Asphalt shingle', 1.0, 'https://images.unsplash.com/photo-1632759145351-1d592919f522?w=300&h=300&fit=crop'),
            description: 'The most common residential roof — straightforward standard mounting.' },
          { ...optImg('Tile (clay / concrete)', 1.18, 'https://images.unsplash.com/photo-1632758848198-83ad0c8c8b1e?w=300&h=300&fit=crop'),
            description: 'Clay or concrete tile — needs careful tile-hook mounting.' },
          { ...optImg('Metal standing seam', 1.1, 'https://images.unsplash.com/photo-1545562083-c2c34f6b5fb6?w=300&h=300&fit=crop'),
            description: 'Standing-seam metal — clamp mounts, no roof penetrations.' },
          { ...optImg('Flat / membrane', 1.12, 'https://images.unsplash.com/photo-1559302995-f1d7e9c5a3f5?w=300&h=300&fit=crop'),
  ...
  /* ── 44. Appliance repair ── */
  {
    ...
    fields: [
      ...
      { id: 'appliance', name: 'Appliance', label: 'Which appliance?', type: 'radio',
        ...
        options: [
          { ...optImg('Refrigerator', 220, 'https://images.unsplash.com/photo-1556909211-36987daf7b4d?w=300&h=300&fit=crop'),
            description: 'Cooling, ice-maker, water line and compressor faults.' },
          { ...optImg('Dishwasher', 180, 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=300&h=300&fit=crop'),
            description: 'Drainage, leaks, no-clean cycles and pump issues.' },
          { ...optImg('Washer / dryer', 195, 'https://images.unsplash.com/photo-1556911220-bff31c812dba?w=300&h=300&fit=crop'),
            description: 'No-spin, no-heat, drum noise and drainage faults.' },
          { ...optImg('Range / oven', 210, 'https://images.unsplash.com/photo-1600585152220-90363fe7e115?w=300&h=300&fit=crop'),
            description: 'Burner, igniter, heating-element and thermostat faults.' },
          { ...optImg('Microwave', 145, 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=300&h=300&fit=crop'),
            description: 'No-heat, turntable and door-switch repairs.' },
          { ...optImg('Garbage disposal', 130, 'https://images.unsplash.com/photo-1527515637462-cff94eecc1ac?w=300&h=300&fit=crop'),
