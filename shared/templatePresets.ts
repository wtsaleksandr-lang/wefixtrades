...
export const TEMPLATE_PRESETS: TemplateConfig[] = [
  ...
  /* ── 2. Driveway paving ── */
  {
    ...
    fields: [
      ...
      { id: 'material', name: 'Surface Material', label: 'Driveway surface material', type: 'radio',
        ...
        options: [
          { ...optImg('Asphalt', 4, '/template-images/surface-asphalt-driveway.jpg'),
            description: 'Budget-friendly black-top — fast to lay and seal.' },
          { ...optImg('Concrete', 6, '/template-images/surface-concrete-driveway.jpg'),
            description: 'Durable poured concrete — clean, low-maintenance finish.' },
          { ...optImg('Block paving', 9, '/template-images/surface-block-paving.jpg'),
            description: 'Interlocking pavers — premium look, easy spot repairs.' },
          { ...optImg('Resin', 11, '/template-images/surface-resin-driveway.jpg'),
  ...
  /* ── 4. Energy efficiency upgrade ── */
  {
    ...
    fields: [
      ...
      { id: 'upgrade', name: 'Upgrade Type', label: 'Which upgrade are you considering?', type: 'radio',
        ...
        options: [
          { ...optImg('Insulation', 0, '/template-images/upgrade-insulation.jpg'),
            description: 'The cheapest, fastest payback — seals the envelope first.' },
          { ...optImg('Windows', 1500, '/template-images/upgrade-windows-efficient.jpg'),
            description: 'Energy-efficient glass cuts drafts and outside noise.' },
          { ...optImg('HVAC', 4000, '/template-images/upgrade-hvac-unit.jpg'),
            description: 'High-efficiency heating and cooling — big monthly savings.' },
          { ...optImg('Solar', 8000, '/template-images/upgrade-solar-panels.jpg'),
  ...
  /* ── 5. Landscaping ── */
  {
    ...
    fields: [
      ...
      { id: 'service', name: 'Service', label: 'Which service do you need?', type: 'radio',
        ...
        options: [
          { ...optImg('Mowing & tidy-up', 0.3, '/template-images/landscape-mowing.jpg'),
            description: 'Regular mow, edge and tidy to keep things sharp.' },
          { ...optImg('Full maintenance', 0.65, '/template-images/landscape-full-maintenance.jpg'),
            description: 'Mowing plus beds, hedges and seasonal care.' },
          { ...optImg('Garden redesign', 2, '/template-images/landscape-redesign.jpg'),
  ...
  /* ── 6. Gutter cleaning ── */
  {
    ...
    fields: [
      ...
      { id: 'difficulty', name: 'Cleaning Difficulty', label: 'How tough is the access?', type: 'radio',
        ...
        options: [
          { ...optImg('Easy', 0, '/template-images/access-easy-single-story.jpg'),
            description: 'Single-story, ladder sits flat on level ground.' },
          { ...optImg('Moderate', 35, '/template-images/access-moderate-two-story.jpg'),
            description: 'Two-story or steeper pitch — taller ladders, more setup.' },
          { ...optImg('Difficult', 80, '/template-images/access-difficult-steep.jpg'),
  ...
  /* ── 7. Fence installation ── */
  {
    ...
    fields: [
      ...
      { id: 'material', name: 'Fence Type', label: 'Fence material', type: 'radio',
        ...
        options: [
          { ...optImg('Timber panel', 12, '/template-images/fence-timber-panel.jpg'),
            description: 'Classic wood panels — budget-friendly and quick to install.' },
          { ...optImg('Closeboard', 16, '/template-images/fence-closeboard.jpg'),
            description: 'Overlapping vertical boards — sturdier and more private.' },
          { ...optImg('Composite', 24, '/template-images/fence-composite.jpg'),
            description: 'Low-maintenance composite — never needs staining.' },
          { ...optImg('Metal railing', 29, '/template-images/fence-metal-railing.jpg'),
  ...
  /* ── 8. Roof repair ── */
  {
    ...
    fields: [
      ...
      { id: 'roof_type', name: 'Roof Type', label: 'Roof material', type: 'radio',
        ...
        options: [
          { ...optImg('Shingle', 4, '/template-images/roof-asphalt-shingle.jpg'),
            description: 'Asphalt shingle — the most common, fastest to repair.' },
          { ...optImg('Metal', 7, '/template-images/roof-metal-standing-seam.jpg'),
            description: 'Standing-seam metal — long-lasting, specialty labor.' },
          { ...optImg('Tile', 9, '/template-images/roof-tile-clay.jpg'),
  ...
  /* ── 10. Interior painting ── */
  {
    ...
    fields: [
      ...
      { id: 'finish', name: 'Finish Quality', label: 'Paint finish quality', type: 'radio',
        ...
        options: [
          { ...optImg('Standard', 0.85, '/template-images/paint-finish-standard.jpg'),
            description: 'Quality matte — great for low-traffic bedrooms and ceilings.' },
          { ...optImg('Premium', 1.3, '/template-images/paint-finish-premium.jpg'),
            description: 'Washable satin — the popular choice for living spaces.' },
          { ...optImg('Designer', 1.85, '/template-images/paint-finish-designer.jpg'),
  ...
  /* ── 11. House renovation ── */
  {
    ...
    // Showcase style — warm slate-and-amber contractor palette, deep charcoal
    // result panel, brass CTA. Renovation scope carries wide on-site variance
    // → range on. Never falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#b45309',
      background: '#faf8f5',
    ...
    steps: [
      { id: 'step_scope', label: 'Scope & materials', help: 'Area and material grade set the bulk of the budget.', fields: ['area', 'material'] },
      { id: 'step_labor', label: 'Labor', help: 'Crew rate and estimated hours — we refine both at the walk-through.', fields: ['labor_rate', 'labor_hours'] },
    ],
    fields: [
      { id: 'area', name: 'Area to Renovate', label: 'Area to renovate (sqft)', type: 'slider',
        ...
        help: 'A rough floor area is fine — a full single-floor reno is usually 800-1,600 sqft.' },
      { id: 'material', name: 'Material Cost', label: 'Material cost per sqft', type: 'number',
        min: 5, max: 200, step: 1, default_value: 33, unit: '$',
        help: 'Builder-grade finishes run $20-35/sqft; premium tile, stone and cabinetry push past $60.' },
      { id: 'labor_rate', name: 'Labor Rate', label: 'Labor rate per hour', type: 'number',
        min: 10, max: 150, step: 1, default_value: 55, unit: '$',
        help: 'A blended crew rate covers the trades on site — leave the default if you are unsure.' },
      { id: 'labor_hours', name: 'Labor Hours', label: 'Estimated labor hours', type: 'slider',
        min: 10, max: 500, step: 5, default_value: 180, unit: 'hrs',
        help: 'The hands-on hours across the whole job — we confirm this from the detailed scope.' },
    ],
    calculations: [
      { ...calc('Material Cost', '[Area to Renovate] * [Material Cost]'), caption: 'Materials across the renovated area.' },
      { ...calc('Labor Cost', '[Labor Rate] * [Labor Hours]'), caption: 'Crew rate over the estimated build hours.' },
      { ...calc('Total Renovation Cost', '[Material Cost] + [Labor Cost]'),
        resultMode: 'primary', caption: 'Your itemised estimate — confirmed and locked at a free on-site walk-through.' },
    ],
    ...
    results: {
      ...
      cta_heading: 'Licensed crews, transparent pricing',
      cta_sub: 'Book a free walk-through — we itemise materials and labor line-by-line and lock your price for 30 days.',
      submit_success: 'Booked! Your project manager will confirm the walk-through time and bring a detailed line-item estimate.',
  ...
  /* ── 15. Deep home cleaning ── */
  {
    ...
    fields: [
      ...
      { id: 'condition', name: 'Condition', label: 'What condition is the home in?', type: 'radio',
        ...
        options: [
          { ...optImg('Lightly soiled', 0, '/template-images/clean-light-soil.jpg'),
            description: 'Generally tidy, kept up with regular cleaning.' },
          { ...optImg('Average', 60, '/template-images/clean-average-soil.jpg'),
            description: 'A few months since the last thorough clean.' },
          { ...optImg('Heavily soiled', 180, '/template-images/clean-heavy-soil.jpg'),
  ...
  /* ── 16. Move-in / move-out cleaning ── */
  {
    ...
    // Showcase style — fresh teal-and-white move-day palette, deep slate
    // result panel, cyan CTA. Per-sqft pricing is fairly exact → range off.
    style: {
      widgetWidth: 'wide',
      accent: '#0d9488',
      background: '#f1faf8',
    ...
    steps: [
      { id: 'step_home', label: 'Home & condition', help: 'Size and how the home is being left set the base clean.', fields: ['sqft', 'condition'] },
      { id: 'step_timing', label: 'Timing & extras', help: 'When you need it done, plus any add-on services.', fields: ['urgency', 'extras'] },
    ],
    fields: [
      { id: 'sqft', name: 'Home Size', label: 'Home size (sqft)', type: 'slider',
        min: 300, max: 5000, step: 50, default_value: 1400, unit: 'sqft',
        help: 'A rough size is fine — most apartments run 600-1,200 sqft, houses 1,400-2,500.' },
      // Image-card radio on the highest-uncertainty question (move-out condition).
      { id: 'condition', name: 'Move-Out Condition', label: 'How is the home being left?', type: 'radio',
        help: 'Be honest here — it only changes scope, and an accurate read keeps your quote firm.',
        options: [
          { ...optImg('Fairly clean', 0, '/template-images/clean-fairly-clean.jpg'),
            description: 'Lightly lived-in — just needs the landlord-checklist reset.' },
          { ...optImg('Average', 80, '/template-images/clean-average-moveout.jpg'),
            description: 'Normal wear — grease, dust and bathroom buildup to cut through.' },
          { ...optImg('Rough', 220, '/template-images/clean-rough-moveout.jpg'),
            description: 'Heavy buildup or long-neglected — needs extra hours and product.' },
        ] },
      { id: 'urgency', name: 'Urgency', label: 'When do you need it done?', type: 'radio',
        help: 'Same-day and 48-hour crews jump the queue, so they carry a small rush fee.',
        options: [
          { ...opt('Within a week', 0), description: 'Plenty of lead time — best availability and price.' },
          opt('Within 48 hours', 60),
          opt('Same-day rush', 150),
        ] },
      { id: 'extras', name: 'Extras', label: 'Add-on services', type: 'multi_select',
        help: 'Add anything your lease checklist calls out — appliances and walls are the usual ones.',
        options: [opt('Inside appliances', 60), opt('Carpet shampoo', 120), opt('Wall touch-up wash', 50), opt('Garage', 80)] },
    ],
    calculations: [
      { ...calc('Home Size Base', '[Home Size] * 0.22'), caption: 'Per-sqft clean across the whole home.' },
      { ...calc('Condition & Urgency', '[Move-Out Condition] + [Urgency]'), caption: 'Extra hours for condition and any rush timing.' },
      { ...calc('Add-on Services', '[Extras]'), caption: 'The checklist add-ons you selected.' },
      { ...calc('Estimated Quote', '[Home Size Base] + [Condition & Urgency] + [Add-on Services]'),
        resultMode: 'primary', caption: 'Your move-out price — locked to your landlord\'s checklist.' },
    ],
    result_calc: 'Estimated Quote',
    results: {
      ...
      cta_heading: 'Get your deposit back — guaranteed',
      cta_sub: 'Book a bonded crew built around your landlord\'s checklist. Fail the inspection and we re-clean free within 48 hours.',
      submit_success: 'Booked! We will confirm your crew and time, and bring the standard move-out checklist with us.',
  ...
  /* ── 17. Office / commercial cleaning ── */
  {
    ...
    // Showcase style — professional steel-blue palette, dark navy result
    // panel, cyan CTA. Per-visit pricing is fairly exact → range off.
    style: {
      widgetWidth: 'wide',
      accent: '#0369a1',
      background: '#f3f7fb',
    ...
    steps: [
      { id: 'step_space', label: 'Space & cadence', help: 'Office size and how often we visit set the per-visit base.', fields: ['sqft', 'frequency'] },
      { id: 'step_service', label: 'Timing & extras', help: 'When our team comes, plus any included services.', fields: ['time', 'extras'] },
    ],
    fields: [
      { id: 'sqft', name: 'Office Size', label: 'Office size (sqft)', type: 'slider',
        min: 500, max: 25000, step: 100, default_value: 4000, unit: 'sqft',
        help: 'A rough floor area is fine — most small offices run 2,000-6,000 sqft.' },
      // Image-card radio on the highest-uncertainty question (visit cadence).
      { id: 'frequency', name: 'Frequency', label: 'How often do you want service?', type: 'radio',
        help: 'More-frequent visits cost less per visit and keep the space consistently clean.',
        options: [
          { ...optImg('Daily — 5x / week', 1.0, '/template-images/freq-daily.jpg'),
            description: 'A spotless office every business day — best per-visit rate.' },
          { ...optImg('Three times a week', 0.85, '/template-images/freq-three-week.jpg'),
            description: 'High-traffic offices that need regular upkeep.' },
          { ...optImg('Weekly', 0.65, '/template-images/freq-weekly.jpg'),
            description: 'A thorough once-a-week reset for smaller teams.' },
          { ...optImg('Bi-weekly', 0.55, '/template-images/freq-biweekly.jpg'),
            description: 'Light-use spaces that need a clean every other week.' },
        ] },
      { id: 'time', name: 'Time of Service', label: 'When should our team come?', type: 'radio',
        help: 'After-hours and weekend crews avoid disrupting your team but cost a little more.',
        options: [
          { ...opt('Business hours', 0), description: 'Discreet daytime cleaning around your staff.' },
          opt('After hours', 35),
          opt('Weekends only', 60),
        ] },
      { id: 'extras', name: 'Extras', label: 'Included services', type: 'multi_select',
        help: 'Add the tasks you want on every visit — adjust anytime.',
        options: [opt('Restroom sanitation', 25), opt('Trash removal', 15), opt('Floor buffing', 65), opt('Window interior', 45)] },
    ],
    calculations: [
      { ...calc('Office Cleaning Base', '[Office Size] * 0.06 * [Frequency]'), caption: 'Per-sqft cleaning scaled by your visit cadence.' },
      { ...calc('Time-of-service Surcharge', '[Time of Service]'), caption: 'After-hours or weekend scheduling.' },
      { ...calc('Included Services', '[Extras]'), caption: 'The recurring tasks you selected.' },
      { ...calc('Per-Visit Cost', '[Office Cleaning Base] + [Time-of-service Surcharge] + [Included Services]'),
        resultMode: 'primary', caption: 'Your per-visit price — multi-month contracts unlock 8-15% savings.' },
    ],
    ...
    results: {
      ...
      cta_heading: 'Bonded crews, flexible scheduling',
      cta_sub: 'Book a walk-through — OSHA-compliant, bonded staff, and contract savings up to 15%.',
      submit_success: 'Booked! We will confirm your walk-through time and a tailored per-visit plan shortly.',
  ...
  /* ── 18. Window cleaning ── */
  {
    ...
    // Showcase style — clean glass-blue palette, deep teal result panel,
    // cyan CTA. Per-window pricing is exact → range off.
    style: {
      widgetWidth: 'wide',
      accent: '#0e7490',
      background: '#f2f9fa',
    ...
    steps: [
      { id: 'step_scope', label: 'Your windows', help: 'Window count and building height set the base cleaning time.', fields: ['windows', 'stories', 'high_access'] },
      { id: 'step_detail', label: 'Sides & detail', help: 'Inside-and-out plus optional screen and track detailing.', fields: ['sides', 'screens', 'tracks'] },
    ],
    fields: [
      { id: 'windows', name: 'Windows', label: 'Number of windows', type: 'slider',
        min: 1, max: 60, step: 1, default_value: 18, unit: 'windows',
        help: 'A rough count is fine — a typical 3-bed home has around 15-20 panes.' },
      // Image-card radio on the highest-uncertainty question (building height).
      { id: 'stories', name: 'Stories', label: 'Building height', type: 'radio',
        help: 'Taller buildings need pole or ladder reach, which adds time and safety setup.',
        options: [
          { ...optImg('Single-story', 0, '/template-images/height-single-story.jpg'),
            description: 'Ground-floor reach with pure-water poles — fastest clean.' },
          { ...optImg('Two-story', 4, '/template-images/height-two-story.jpg'),
            description: 'Upper windows reached with extension poles from the ground.' },
          { ...optImg('Three+ story', 9, '/template-images/height-three-story.jpg'),
            description: 'High-rise reach needing ladders or a lift and extra safety setup.' },
        ] },
      // show_if — a high-access safety surcharge only applies on three+ story.
      { id: 'high_access', name: 'High-Access Safety Setup', label: 'Add high-access safety setup', type: 'toggle',
        help: 'Anchored lines and a spotter for windows above two stories.',
        on_value: 90,
        show_if: { field: 'stories', op: 'eq', value: 'three_story' } },
      { id: 'sides', name: 'Sides', label: 'Which sides should we clean?', type: 'select',
        help: 'Inside-and-out doubles the panes we wipe down per window.',
      ...
      { id: 'screens', name: 'Screens', label: 'Include window screens', type: 'toggle', on_value: 45,
        help: 'We pop, wash and re-seat every screen so they go back lint-free.' },
      { id: 'tracks', name: 'Tracks', label: 'Detail-clean the tracks & sills', type: 'toggle', on_value: 35,
        help: 'Vacuum and wipe the dirt that collects in sliding tracks and sills.' },
    ],
    calculations: [
      { ...calc('Window Cleaning', '[Windows] * (8 + [Stories]) * [Sides]'), caption: 'Per-window rate scaled by height and inside-vs-outside.' },
      { ...calc('Screens & Tracks', '[Screens] + [Tracks] + [High-Access Safety Setup]'), caption: 'Optional screen, track and high-access add-ons.' },
      { ...calc('Estimated Quote', '[Window Cleaning] + [Screens & Tracks]'),
        resultMode: 'primary', caption: 'Your window-cleaning price — backed by a 7-day streak-free guarantee.' },
    ],
    result_calc: 'Estimated Quote',
    results: {
      ...
      cta_heading: 'Streak-free, or we come back free',
      cta_sub: 'Pick a date — fully insured, pure-water poles, and a 7-day guarantee on every pane.',
      submit_success: 'Booked! We will confirm your window-cleaning date and arrival window shortly.',
  ...
  /* ── 19. Kitchen renovation ── */
  {
    ...
    fields: [
      ...
      { id: 'counters', name: 'Countertops', label: 'Which countertop material?', type: 'radio',
        ...
        options: [
          { ...optImg('Quartz', 75, '/template-images/counter-quartz.jpg'),
            description: 'Engineered, non-porous, near-zero maintenance — the most-chosen surface.' },
          { ...optImg('Granite', 85, '/template-images/counter-granite.jpg'),
            description: 'Natural stone, every slab unique — needs periodic sealing.' },
          { ...optImg('Laminate', 30, '/template-images/counter-laminate.jpg'),
            description: 'Budget-friendly with hundreds of patterns.' },
          { ...optImg('Marble', 130, '/template-images/counter-marble.jpg'),
  ...
  /* ── 20. Bathroom renovation ── */
  {
    ...
    fields: [
      ...
      { id: 'shower', name: 'Shower / Tub', label: 'Which shower or tub configuration?', type: 'radio',
        ...
        options: [
          { ...optImg('Walk-in shower', 3400, '/template-images/bath-walk-in-shower.jpg'),
            description: 'Curbless or low-curb tiled shower — the most-requested upgrade.' },
          { ...optImg('New tub-shower combo', 1800, '/template-images/bath-tub-shower-combo.jpg'),
            description: 'One-piece value option — keeps both bath and shower.' },
          { ...optImg('Freestanding tub', 4200, '/template-images/bath-freestanding-tub.jpg'),
            description: 'Spa centerpiece — usually paired with a separate shower.' },
          { ...optImg('Keep existing', 0, '/template-images/bath-keep-existing.jpg'),
  ...
  /* ── 21. Basement finishing ── */
  {
    ...
    // Showcase style — warm-wood-and-charcoal finished-basement palette, deep
    // graphite result panel, amber CTA. Build scope drives wide variance →
    // range on. Never falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#b45309',
    ...
    steps: [
      { id: 'step_shell', label: 'Size & ceiling', help: 'Floor area and ceiling treatment set the framing base.', fields: ['sqft', 'ceiling'] },
      { id: 'step_build', label: 'Rooms & code', help: 'The rooms you add, plus a code-required egress window.', fields: ['rooms', 'egress'] },
    ],
    fields: [
      { id: 'sqft', name: 'Basement Size', label: 'Basement size (sqft)', type: 'slider',
        min: 200, max: 2500, step: 50, default_value: 900, unit: 'sqft',
        help: 'The finished footprint — most homes finish 700-1,200 sqft of basement.' },
      // Image-card radio on the highest-uncertainty question (ceiling treatment).
      { id: 'ceiling', name: 'Ceiling', label: 'Ceiling treatment', type: 'radio',
        help: 'Drywall looks most like upstairs; drop tile keeps pipes and wiring accessible.',
        options: [
          { ...optImg('Exposed (painted)', 8, '/template-images/ceiling-exposed-painted.jpg'),
            description: 'Industrial look — joists and ducts painted out. Cheapest, full access overhead.' },
          { ...optImg('Drop tile', 14, '/template-images/ceiling-drop-tile.jpg'),
            description: 'Suspended grid that hides utilities but lifts out for plumbing access.' },
          { ...optImg('Full drywall', 22, '/template-images/ceiling-full-drywall.jpg'),
            description: 'A true upstairs-grade finished ceiling — the highest-value choice.' },
        ] },
      { id: 'rooms', name: 'Rooms', label: 'Rooms to add', type: 'multi_select',
        help: 'Each room adds rough-in plumbing, electrical and finish work — pick what you want built.',
      ...
      { id: 'egress', name: 'Egress Window', label: 'Add code-required egress window', type: 'toggle', on_value: 3200,
        help: 'Any basement bedroom legally needs an egress window — we include the cut and well.' },
    ],
    calculations: [
      { ...calc('Framing & Ceiling', '[Basement Size] * [Ceiling]'), caption: 'Framing, insulation and your chosen ceiling across the space.' },
      { ...calc('Rooms', '[Rooms]'), caption: 'Build-out for the rooms you selected.' },
      { ...calc('Egress Window', '[Egress Window]'), caption: 'Code-required egress cut and window well.' },
      { ...calc('Estimated Project Cost', '[Framing & Ceiling] + [Rooms] + [Egress Window]'),
        resultMode: 'primary', caption: 'Your turnkey finish estimate — confirmed at a free on-site walk-through.' },
    ],
    result_calc: 'Estimated Project Cost',
    results: {
      ...
      cta_heading: 'Add living space that pays you back',
      cta_sub: 'Book a free walk-through — we handle permits and inspections, and finished basements return ~70% at resale.',
      submit_success: 'Booked! Your project manager will confirm the walk-through and bring a detailed finish plan.',
     ...
     the deep per-template Playwright spec (PR #372). */
  {
    ...
    // Showcase style — warm neutral palette, deep-charcoal result panel,
    // amber CTA. Per-sqft pricing is fairly exact → modest range.
    style: {
      widgetWidth: 'wide',
      accent: '#7c3aed',
      background: '#f7f5fb',
    ...
    steps: [
      { id: 'step_area', label: 'Area & coverage', help: 'Wall area, coats and ceiling height set the bulk of the price.', fields: ['sqft', 'coats', 'ceiling_height'] },
      { id: 'step_prep', label: 'Prep & trim', help: 'Wall repairs and trim work are priced separately.', fields: ['prep', 'trim'] },
    ],
    fields: [
      { id: 'sqft', name: 'Wall Area', label: 'Wall area to paint (sqft)', type: 'slider',
        min: 200, max: 5000, step: 50, default_value: 1600, unit: 'sqft',
        help: 'A rough estimate is fine — a 12x12 room is roughly 400 sqft of wall.' },
      // Image-card radio on the highest-uncertainty question (coats).
      { id: 'coats', name: 'Coats', label: 'Number of paint coats', type: 'radio',
        help: 'Two coats give the most even, durable finish — especially over a color change.',
        options: [
          { ...optImg('One coat', 1.0, '/template-images/paint-one-coat.jpg'),
            description: 'A refresh over a similar color — lightest coverage.' },
          { ...optImg('Two coats — recommended', 1.6, '/template-images/paint-two-coats.jpg'),
            description: 'Full, even coverage that hides the old color and lasts.' },
        ] },
      { id: 'ceiling_height', name: 'Ceiling Height', label: 'Ceiling height', type: 'select',
        help: 'Higher ceilings need scaffolding and more cut-in time.',
      ...
      { id: 'prep', name: 'Prep', label: 'Prep work required', type: 'multi_select',
        help: 'Pick any walls that need repair before paint — we confirm on a walk-through.',
        options: [
          { ...opt('Patch holes', 120), description: 'Fill and sand nail holes, dents and cracks.' },
          opt('Sand & prime', 180),
          opt('Remove wallpaper', 400),
        ] },
      { id: 'trim', name: 'Trim', label: 'Include trim & doors', type: 'toggle', on_value: 350,
        help: 'Baseboards, casings and doors painted to match the walls.' },
    ],
    calculations: [
      { ...calc('Paint & Labor', '[Wall Area] * 1.3 * [Coats] * [Ceiling Height]'), caption: 'Per-sqft paint and labor scaled by coats and ceiling height.' },
      { ...calc('Prep Work', '[Prep]'), caption: 'Wall repairs selected before painting.' },
      { ...calc('Trim & Doors', '[Trim]'), caption: 'Optional trim, casing and door painting.' },
      { ...calc('Estimated Quote', '[Paint & Labor] + [Prep Work] + [Trim & Doors]'),
        resultMode: 'primary', caption: 'Your painting estimate — premium paint and all prep included, scope confirmed on-site.' },
    ],
    result_calc: 'Estimated Quote',
    results: {
      heading: 'Your Painting Quote',
      show_breakdown: true,
      cta_label: 'Reserve My Slot',
      cta_heading: 'Premium finish, fully warranted',
      cta_sub: 'Reserve a date — Sherwin-Williams certified, lead-safe, with a 3-year workmanship warranty.',
      submit_success: 'Reserved! We will confirm your painting dates and a quick on-site walk-through shortly.',
  ...
  /* ── 23. HVAC installation ── */
  {
    ...
    fields: [
      ...
      { id: 'efficiency', name: 'Efficiency Tier', label: 'Which efficiency tier?', type: 'radio',
        ...
        options: [
          { ...optImg('Standard — 14 SEER', 1.0, '/template-images/hvac-tier-standard.jpg'),
            description: 'Meets code, lowest upfront cost.' },
          { ...optImg('High-efficiency — 18 SEER', 1.25, '/template-images/hvac-tier-high.jpg'),
            description: 'The popular middle tier — noticeable bill savings.' },
          { ...optImg('Top tier — 20+ SEER', 1.5, '/template-images/hvac-tier-top.jpg'),
  ...
  /* ── 24. Plumbing service ── */
  {
    ...
    fields: [
      ...
      { id: 'service', name: 'Service', label: 'What plumbing work do you need?', type: 'radio',
        ...
        options: [
          { ...optImg('Leak repair', 220, '/template-images/plumb-leak-repair.jpg'),
            description: 'Dripping or burst supply line, valve or joint.' },
          { ...optImg('Drain clearing', 180, '/template-images/plumb-drain-clearing.jpg'),
            description: 'Slow or blocked sink, tub or main line.' },
          { ...optImg('Faucet replacement', 280, '/template-images/plumb-faucet-replace.jpg'),
            description: 'Swap a worn faucet for a new fixture you supply or we provide.' },
          { ...optImg('Toilet replacement', 420, '/template-images/plumb-toilet-replace.jpg'),
            description: 'Remove the old unit, reset the flange and install a new toilet.' },
          { ...optImg('Water heater install', 1800, '/template-images/plumb-water-heater-install.jpg'),
  ...
  /* ── 25. Electrical work ── */
  {
    ...
    fields: [
      ...
      { id: 'job_type', name: 'Job Type', label: 'What electrical work do you need?', type: 'radio',
        ...
        options: [
          { ...optImg('Add outlet / switch', 175, '/template-images/elec-outlet-switch.jpg'),
            description: 'A new receptacle or switch on an existing circuit.' },
          { ...optImg('New light fixture', 220, '/template-images/elec-light-fixture.jpg'),
            description: 'Swap or add a ceiling or wall light fixture.' },
          { ...optImg('Ceiling fan install', 290, '/template-images/elec-ceiling-fan.jpg'),
            description: 'Mount and wire a fan, with a rated box if needed.' },
          { ...optImg('Panel upgrade (200A)', 2400, '/template-images/elec-panel-upgrade.jpg'),
            description: 'Replace the main panel with a modern 200A service.' },
          { ...optImg('Whole-home rewire', 8500, '/template-images/elec-whole-rewire.jpg'),
      ...
      { id: 'access', name: 'Access', label: 'Wiring access difficulty', type: 'radio',
        ...
        options: [
          { ...optImg('Easy (open wall / accessible)', 0, '/template-images/access-elec-easy.jpg'),
            description: 'Unfinished basement, garage or open framing.' },
          { ...optImg('Moderate', 45, '/template-images/access-elec-moderate.jpg'),
            description: 'Some drywall removal or attic access required.' },
          { ...optImg('Difficult (finished wall, tight crawl)', 120, '/template-images/access-elec-difficult.jpg'),
  ...
  /* ── 26. EV charger installation ── */
  {
    ...
    // Showcase style — clean electric-blue palette, deep navy result panel,
    // cyan CTA. Install scope (panel + wire run) drives variance → range on.
    // Never falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#2563eb',
    ...
    steps: [
      { id: 'step_charger', label: 'Charger & run', help: 'Charger level and the cable run from your panel set the base.', fields: ['charger_level', 'wire_distance'] },
      { id: 'step_electrical', label: 'Panel & extras', help: 'Whether your panel needs work, plus permits and add-ons.', fields: ['panel_upgrade', 'extras'] },
    ],
    fields: [
      // Image-card radio on the highest-uncertainty question (charger level).
      { id: 'charger_level', name: 'Charger Level', label: 'Charger level', type: 'radio',
        help: 'Level 2 is the standard home choice — it adds ~25-35 miles of range per hour.',
        options: [
          { ...opt('Level 1 (120V)', 350),
            description: 'Plugs into a normal outlet — slow, fine for plug-in hybrids and low daily miles.' },
          { ...opt('Level 2 (240V, 32A)', 950),
            description: 'The popular home setup — a full overnight charge for most EVs.' },
          { ...opt('Level 2 (240V, 50A)', 1250),
            description: 'Fastest home charging — best for long commutes or two EVs.' },
        ] },
      { id: 'wire_distance', name: 'Wire Distance', label: 'Distance from electrical panel (ft)', type: 'slider',
        ...
        help: 'Roughly how far the charger sits from your breaker panel — longer runs add cable and labor.' },
      { id: 'panel_upgrade', name: 'Panel Upgrade', label: 'Panel capacity available?', type: 'radio',
        help: 'Not sure? Leave the default — our electrician confirms capacity on the free site check.',
        options: [
          { ...opt('No (panel has capacity)', 0), description: 'Your panel has a free 240V slot — no upgrade needed.' },
          opt('Subpanel add', 1100),
          opt('Full panel upgrade', 2400),
        ] },
      { id: 'extras', name: 'Extras', label: 'Optional add-ons', type: 'multi_select',
        help: 'Permit and inspection are required in most areas — we handle the paperwork.',
        options: [opt('Permit + inspection', 220), opt('Trenching (outdoor)', 380), opt('Smart load-management module', 280)] },
    ],
    calculations: [
      { ...calc('Charger & Install', '[Charger Level] + [Wire Distance] * 8'), caption: 'Charger unit plus the cable run from your panel.' },
      { ...calc('Panel Upgrade', '[Panel Upgrade]'), caption: 'Any subpanel or service upgrade needed for capacity.' },
      { ...calc('Permits & Add-ons', '[Extras]'), caption: 'Permits, trenching and smart-charging options.' },
      { ...calc('Estimated Project Cost', '[Charger & Install] + [Panel Upgrade] + [Permits & Add-ons]'),
        resultMode: 'primary', caption: 'Your installed price — confirmed at a free site check, before any rebates.' },
    ],
    result_calc: 'Estimated Project Cost',
    results: {
      ...
      cta_heading: 'Certified install, same-day in most cases',
      cta_sub: 'Book a licensed EV installer — permit, inspection and rebate paperwork handled for you.',
      submit_success: 'Booked! We will confirm your install window and file any utility rebate paperwork on your behalf.',
  ...
  /* ── 27. Lawn care subscription ── */
  {
    ...
    fields: [
      ...
      { id: 'frequency', name: 'Frequency', label: 'How often do you want service?', type: 'radio',
        ...
        options: [
          { ...optImg('Weekly', 1.0, '/template-images/freq-weekly.jpg'),
            description: 'Best results — a manicured lawn all season.' },
          { ...optImg('Bi-weekly', 0.65, '/template-images/freq-biweekly.jpg'),
            description: 'The popular balance of cost and curb appeal.' },
          { ...optImg('Monthly', 0.45, '/template-images/freq-monthly.jpg'),
  ...
  /* ── 28. Concrete driveway replacement ── */
  {
    ...
    layout: 'single-column', theme: 'midnight', defaultIcon: 'Construction',
    requireAddress: true,
    // Showcase style — cool slate-and-stone palette, dark graphite result
    // panel, amber CTA. Finish + prep drive variance → modest range.
    style: {
      widgetWidth: 'wide',
      accent: '#475569',
      background: '#f5f6f8',
    ...
    steps: [
      { id: 'step_pour', label: 'Size & finish', help: 'Driveway size, finish and thickness set the bulk of the pour cost.', fields: ['area', 'finish', 'thickness'] },
      { id: 'step_prep', label: 'Prep & reinforcement', help: 'Tear-out, rebar and drainage are priced separately.', fields: ['extras'] },
    ],
    fields: [
      { id: 'area', name: 'Driveway Area', label: 'Driveway size (sqft)', type: 'slider',
        min: 100, max: 2000, step: 25, default_value: 600, unit: 'sqft',
        help: 'A rough size is fine — a typical two-car driveway is about 600 sqft.' },
      // Image-card radio on the highest-uncertainty question (finish type).
      { id: 'finish', name: 'Finish', label: 'Concrete finish type', type: 'radio',
        help: 'A plain broom finish is the most economical; stamped and colored finishes cost more per sqft.',
        options: [
          { ...optImg('Standard broom', 7, '/template-images/concrete-finish-broom.jpg'),
            description: 'Classic textured grey finish — durable and budget-friendly.' },
          { ...optImg('Exposed aggregate', 11, '/template-images/concrete-finish-exposed-aggregate.jpg'),
            description: 'Pebbled, slip-resistant surface with a natural-stone look.' },
          { ...optImg('Stamped pattern', 14, '/template-images/concrete-finish-stamped.jpg'),
            description: 'Patterned concrete that mimics brick, slate or cobblestone.' },
          { ...optImg('Colored + stamped', 18, '/template-images/concrete-finish-colored-stamped.jpg'),
            description: 'Integrally-colored, stamped finish for the highest-end look.' },
        ] },
      { id: 'thickness', name: 'Thickness', label: 'Concrete thickness', type: 'radio',
        help: 'Thicker slabs carry heavier vehicles — 5 inches suits most driveways.',
        options: [
          { ...opt('4 inch — light residential', 1.0), description: 'Cars and light use only.' },
          opt('5 inch — recommended', 1.18),
          opt('6 inch — heavy vehicle', 1.35),
        ] },
      { id: 'extras', name: 'Extras', label: 'Prep & reinforcement', type: 'multi_select',
        help: 'Pick anything the site needs — we confirm on a free on-site measurement.',
        options: [
          { ...opt('Remove old surface', 1100), description: 'Break out and haul away the existing driveway.' },
          opt('Reinforce with rebar', 480),
          opt('Add drainage channel', 620),
        ] },
    ],
    calculations: [
      { ...calc('Pour & Finish', '[Driveway Area] * [Finish] * [Thickness]'), caption: 'Per-sqft pour scaled by finish and slab thickness.' },
      { ...calc('Prep & Reinforcement', '[Extras]'), caption: 'Tear-out, rebar and drainage you selected.' },
      { ...calc('Estimated Project Cost', '[Pour & Finish] + [Prep & Reinforcement]'),
        resultMode: 'primary', caption: 'Your driveway estimate — form work, pour, finish and 28-day cure included.' },
    ],
    result_calc: 'Estimated Project Cost',
    results: {
      ...
      cta_heading: '25-year structural warranty',
      cta_sub: 'Book a free on-site measurement — ACI-certified crews and a quarter-century warranty on every pour.',
      submit_success: 'Booked! We will confirm your free measurement date and arrival window shortly.',
  ...
  /* ── 29. Tree service ── */
  {
    ...
    // Showcase style — deep-forest green palette, dark-pine result panel,
    // amber CTA. Per-tree pricing varies with crew + crane access → range on.
    style: {
      widgetWidth: 'wide',
      accent: '#15803d',
      background: '#f3f8f4',
    ...
    steps: [
      { id: 'step_work', label: 'The work', help: 'What we are doing and how many trees sets the bulk of the price.', fields: ['service', 'trees', 'height'] },
      { id: 'step_access', label: 'Access & cleanup', help: 'How hard the site is to reach, plus optional debris haul-away.', fields: ['access', 'haul'] },
    ],
    fields: [
      // Image-card radio on the highest-uncertainty question (which service).
      { id: 'service', name: 'Service', label: 'What service do you need?', type: 'radio',
        help: 'Trimming is the lightest; full removal with stump grinding is the most involved.',
        options: [
          { ...optImg('Trim / prune', 200, '/template-images/tree-trim-prune.jpg'),
            description: 'Shaping, deadwood and canopy thinning to keep a tree healthy.' },
          { ...optImg('Removal — no stump', 600, '/template-images/tree-removal-no-stump.jpg'),
            description: 'Full take-down, leaving the stump flush to the ground.' },
          { ...optImg('Removal + stump grind', 850, '/template-images/tree-removal-stump-grind.jpg'),
            description: 'Take-down plus grinding the stump below grade for a clean finish.' },
        ] },
      { id: 'trees', name: 'Trees', label: 'How many trees?', type: 'number',
        min: 1, max: 20, step: 1, default_value: 1,
        help: 'Count every tree you want us to work on at this visit.' },
      { id: 'height', name: 'Height', label: 'Tallest tree height', type: 'select',
        help: 'Taller trees need more rigging and time — pick the biggest one on the job.',
      ...
      { id: 'access', name: 'Access', label: 'Site access difficulty', type: 'radio',
        help: 'Tight or overhead spots need extra rigging and crew safety setup.',
        options: [
          { ...opt('Easy — truck access', 0), description: 'Open driveway or yard the crew can pull right up to.' },
          opt('Moderate — gate / yard work', 120),
          opt('Difficult — over house / power lines', 350),
        ] },
      { id: 'haul', name: 'Haul Away', label: 'Haul away debris', type: 'toggle', on_value: 180,
        help: 'We chip and remove all branches and logs — leave it off to keep the wood.' },
    ],
    calculations: [
      { ...calc('Tree Work', '[Service] * [Trees] * [Height]'), caption: 'Service rate scaled by tree count and the tallest tree.' },
      { ...calc('Access Surcharge', '[Access]'), caption: 'Extra rigging for tight or overhead sites.' },
      { ...calc('Debris Haul-away', '[Haul Away]'), caption: 'Optional chipping and removal of all debris.' },
      { ...calc('Estimated Quote', '[Tree Work] + [Access Surcharge] + [Debris Haul-away]'),
        resultMode: 'primary', caption: 'Your tree-service estimate — confirmed on a free on-site assessment.' },
    ],
    result_calc: 'Estimated Quote',
    results: {
      ...
      cta_heading: 'Free on-site assessment, fully insured',
      cta_sub: 'Book a visit — ISA-certified arborists, $2M liability cover, 24/7 storm response.',
      submit_success: 'Booked! An arborist will confirm your assessment time and arrival window shortly.',
  ...
  /* ── 31. Mobile car detailing ── */
  {
    ...
    // Showcase style — sleek graphite-and-cyan automotive palette, near-black
    // result panel, electric-cyan CTA. Per-package pricing is exact → range
    ...
    steps: [
      { id: 'step_vehicle', label: 'Vehicle & package', help: 'Your vehicle size and detail package set the base price.', fields: ['vehicle', 'package'] },
      { id: 'step_addons', label: 'Add-ons & condition', help: 'Optional services, plus how much buildup we are starting from.', fields: ['extras', 'condition'] },
    ],
    fields: [
      // Image-card radio on the highest-uncertainty question (vehicle size).
      { id: 'vehicle', name: 'Vehicle Size', label: 'Vehicle size', type: 'radio',
        help: 'Bigger vehicles take more time and product, so they scale the package price.',
        options: [
          { ...optImg('Sedan / coupe', 1.0, '/template-images/vehicle-sedan.jpg'),
            description: 'Standard 4-door or 2-door car — the baseline rate.' },
          { ...optImg('SUV / mid-size', 1.25, '/template-images/vehicle-suv-mid.jpg'),
            description: 'Crossover or mid-size SUV — a bit more surface and interior.' },
          { ...optImg('Truck / full-size SUV', 1.5, '/template-images/vehicle-truck-full-suv.jpg'),
            description: 'Pickup or large SUV — more glass, panels and cab to detail.' },
          { ...optImg('Van / 3-row SUV', 1.75, '/template-images/vehicle-van-3row.jpg'),
            description: 'Minivan or 3-row — the most interior square footage.' },
        ] },
      { id: 'package', name: 'Package', label: 'Detail package', type: 'select',
        help: 'Full detail is our most-booked; premium and showroom add paint correction and protection.',
      ...
      { id: 'extras', name: 'Extras', label: 'Optional add-ons', type: 'multi_select',
        help: 'Pick anything your vehicle needs — pet hair and odor are the most-requested.',
      ...
      { id: 'condition', name: 'Condition', label: 'Current vehicle condition', type: 'radio',
        help: 'Heavier buildup needs extra hours — an honest read keeps your quote firm.',
        options: [
          { ...opt('Light (regular cleaning)', 0), description: 'Kept up regularly — just needs a refresh.' },
          opt('Moderate (3-6 months neglect)', 30),
          opt('Heavy (over a year)', 75),
        ] },
    ],
    calculations: [
      { ...calc('Detail Package', '[Package] * [Vehicle Size]'), caption: 'Your package scaled to your vehicle size.' },
      { ...calc('Optional Add-ons', '[Extras]'), caption: 'The extra services you selected.' },
      { ...calc('Condition Surcharge', '[Condition]'), caption: 'Extra time for heavier buildup.' },
      { ...calc('Estimated Quote', '[Detail Package] + [Optional Add-ons] + [Condition Surcharge]'),
        resultMode: 'primary', caption: 'Your at-home detail price — we bring everything to your driveway.' },
    ],
    result_calc: 'Estimated Quote',
    results: {
      ...
      cta_heading: 'We come to you — no water hookup needed',
      cta_sub: 'Book an IDA-certified detailer at your home or office. 24-hour satisfaction guarantee on every job.',
      submit_success: 'Booked! We will confirm your detail time and arrive fully self-contained with water, power and pro products.',
  ...
  /* ── 32. Locksmith service ── */
  {
    ...
    // Showcase style — urgent brass-and-charcoal locksmith palette, near-black
    // result panel, brass-amber CTA. Lockout pricing is upfront and exact →
    // range off. Never falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#b45309',
      background: '#f5f5f4',
    ...
    steps: [
      { id: 'step_job', label: 'Job & quantity', help: 'What you need and how many locks set the base price.', fields: ['service', 'quantity'] },
      { id: 'step_timing', label: 'Urgency & timing', help: 'How fast you need us and the time of day.', fields: ['urgency', 'time'] },
    ],
    fields: [
      ...
      { id: 'service', name: 'Service', label: 'What do you need?', type: 'radio',
        help: 'Pick the closest match — our tech confirms the exact job on arrival, price already locked.',
        options: [
          { ...optImg('Home lockout', 95, '/template-images/lock-home-lockout.jpg'),
            description: 'Locked out of the house — non-destructive entry, no damage to your door.' },
          { ...optImg('Car lockout', 110, '/template-images/lock-car-lockout.jpg'),
            description: 'Keys locked in the car — fast roadside entry.' },
          { ...optImg('Rekey lock', 65, '/template-images/lock-rekey.jpg'),
            description: 'Keep your hardware, change the key — ideal after a move.' },
          { ...optImg('New deadbolt install', 180, '/template-images/lock-deadbolt-install.jpg'),
            description: 'Add a fresh, high-security deadbolt to a door.' },
          { ...optImg('Smart lock install', 280, '/template-images/lock-smart-lock.jpg'),
            description: 'Keypad or app-controlled lock fitted and set up.' },
          { ...optImg('Key duplication', 25, '/template-images/lock-key-duplication.jpg'),
            description: 'Spare keys cut on site, including high-security blanks.' },
        ] },
      { id: 'quantity', name: 'Quantity', label: 'How many locks?', type: 'number',
        min: 1, max: 10, step: 1, default_value: 1,
        help: 'How many locks the job covers — most rekeys and installs are 1-3.' },
      { id: 'urgency', name: 'Urgency', label: 'How urgent?', type: 'radio',
        help: 'Emergency response jumps the queue, so the soonest slots carry a call-out fee.',
        options: [
          { ...opt('Within a few days', 0), description: 'Scheduled visit — best price, no rush fee.' },
          opt('Within 24 hours', 35),
          opt('Now (within 1 hour)', 95),
        ] },
      { id: 'time', name: 'Time of Service', label: 'Time of service', type: 'radio',
        help: 'After-hours and overnight crews cost a little more to dispatch.',
        options: [opt('Business hours', 0), opt('After hours / weekend', 45), opt('Overnight / holiday', 95)] },
    ],
    calculations: [
      { ...calc('Service & Materials', '[Service] * [Quantity]'), caption: 'The job rate across the number of locks.' },
      { ...calc('Urgency & Time', '[Urgency] + [Time of Service]'), caption: 'Any rush response and after-hours dispatch.' },
      { ...calc('Estimated Cost', '[Service & Materials] + [Urgency & Time]'),
        resultMode: 'primary', caption: 'Your upfront price — locked before the truck rolls, no surprises on arrival.' },
    ],
    result_calc: 'Estimated Cost',
    results: {
      ...
      show_breakdown: true,
      cta_label: 'Request a Locksmith',
      cta_heading: 'A licensed locksmith, on the way',
      cta_sub: 'Request a bonded, $1M-insured tech — your price is locked before we dispatch, 24/7.',
      submit_success: 'Got it! We are dispatching the nearest licensed locksmith and will text you an arrival time.',
  ...
  /* ── 33. Water damage restoration ── */
  {
    ...
    requireAddress: true,
    // Showcase style — urgent deep-blue palette, dark navy result panel,
    // amber CTA. Severity + scope drive wide cost variance → range on.
    style: {
      widgetWidth: 'wide',
      accent: '#1d4ed8',
      background: '#f2f5fc',
    ...
    steps: [
      { id: 'step_damage', label: 'The damage', help: 'How much is affected and how contaminated the water is sets the scope.', fields: ['area', 'severity'] },
      { id: 'step_response', label: 'Response & scope', help: 'How fast you need us, plus the restoration services to include.', fields: ['response', 'services'] },
    ],
    fields: [
      { id: 'area', name: 'Affected Area', label: 'Affected area (sqft)', type: 'slider',
        min: 50, max: 3000, step: 25, default_value: 350, unit: 'sqft',
        help: 'A rough footprint is fine — one flooded room is roughly 150-250 sqft.' },
      // Image-card radio on the highest-uncertainty question (water category).
      { id: 'severity', name: 'Severity', label: 'Water category', type: 'radio',
        help: 'Cleaner water is faster to dry; contaminated water needs containment and protective gear.',
        options: [
          { ...optImg('Class 1 — clean, minor', 1.0, '/template-images/water-class1-clean.jpg'),
            description: 'Clean-water leak from a supply line or rain — fastest to dry out.' },
          { ...optImg('Class 2 — gray water', 1.4, '/template-images/water-class2-gray.jpg'),
            description: 'Appliance or washing-machine overflow with some contamination.' },
          { ...optImg('Class 3 — extensive saturation', 2.0, '/template-images/water-class3-saturated.jpg'),
            description: 'Water from above soaking walls, ceilings and floors throughout.' },
          { ...optImg('Class 4 — sewage / hazardous', 2.8, '/template-images/water-class4-hazard.jpg'),
            description: 'Black-water or sewage backup — full containment and PPE required.' },
        ] },
      { id: 'response', name: 'Response Time', label: 'How fast do you need us?', type: 'select',
        help: 'Faster dispatch means a crew on the road sooner — drying every hour limits the damage.',
      ...
      { id: 'services', name: 'Services', label: 'Services needed', type: 'multi_select',
        help: 'Pick everything you think you need — we confirm the full scope on-site.',
        options: [
          { ...opt('Water extraction', 350), description: 'Pumping and vacuuming standing water out fast.' },
          opt('Structural drying', 480),
          opt('Mold prevention', 280),
          opt('Contents pack-out', 620),
          opt('Reconstruction estimate', 0),
        ] },
    ],
    calculations: [
      { ...calc('Extraction & Drying', '[Affected Area] * 2.2 * [Severity]'), caption: 'Area-based drying scaled by how contaminated the water is.' },
      { ...calc('Response Surcharge', '[Response Time]'), caption: 'Emergency and after-hours dispatch.' },
      { ...calc('Restoration Services', '[Services]'), caption: 'The restoration services you selected.' },
      { ...calc('Estimated Cost', '[Extraction & Drying] + [Response Surcharge] + [Restoration Services]'),
        resultMode: 'primary', caption: 'Your restoration estimate — most homeowners pay only their insurance deductible.' },
    ],
    result_calc: 'Estimated Cost',
    results: {
      ...
      show_breakdown: true,
      cta_label: 'Get Emergency Help',
      cta_heading: 'A crew on the road, 24/7',
      cta_sub: 'Request dispatch now — IICRC-certified techs, direct insurance billing, drying that starts on day one.',
      submit_success: 'Got it — our dispatch team will call you right away to confirm crew arrival.',
  ...
  /* ── 34. Emergency HVAC repair ── */
  {
    ...
    // Showcase style — urgent ember palette over dark slate, amber CTA.
    // After-hours timing + repairs drive variance → range on.
    style: {
      widgetWidth: 'wide',
      accent: '#ea580c',
      background: '#f6f4f2',
    ...
    steps: [
      { id: 'step_system', label: 'Your system', help: 'Which unit is down and when you need us sets the dispatch fee.', fields: ['system', 'time'] },
      { id: 'step_symptom', label: 'The problem', help: 'What it is doing now, plus any repairs you already expect.', fields: ['issue', 'extras'] },
    ],
    fields: [
      // Image-card radio on the highest-uncertainty question (which system).
      { id: 'system', name: 'System', label: 'Which system is failing?', type: 'radio',
        help: 'Pick the unit that stopped working — it tells the tech what to load on the truck.',
        options: [
          { ...optImg('AC / cooling', 0, '/template-images/hvac-ac-cooling.jpg'),
            description: 'Central air or condenser not cooling the house.' },
          { ...optImg('Furnace / heating', 0, '/template-images/hvac-furnace.jpg'),
            description: 'Gas or electric furnace not producing heat.' },
          { ...optImg('Heat pump', 30, '/template-images/hvac-heat-pump.jpg'),
            description: 'All-in-one heat-and-cool system acting up.' },
          { ...optImg('Mini-split', 45, '/template-images/hvac-mini-split.jpg'),
            description: 'Ductless wall or ceiling unit on the fritz.' },
        ] },
      { id: 'time', name: 'Time of Service', label: 'When do you need us?', type: 'select',
        help: 'After-hours and weekend dispatch carries a higher trip fee.',
      ...
      { id: 'issue', name: 'Symptom', label: 'What\'s the symptom?', type: 'select',
        help: 'A rough description helps the tech bring the right parts on the first trip.',
      ...
      { id: 'extras', name: 'Add-ons', label: 'Likely repairs', type: 'multi_select',
        help: 'Only pick what you already know you need — the tech confirms on-site.',
        options: [
          { ...opt('Refrigerant top-up', 220), description: 'Recharge low refrigerant after a leak fix.' },
          opt('Capacitor replacement', 175),
          opt('Thermostat replacement', 145),
          opt('System tune-up after fix', 95),
        ] },
    ],
    calculations: [
      { ...calc('Diagnostic & Trip', '[Time of Service]'), caption: 'Dispatch and diagnostic fee for the time you need us.' },
      { ...calc('System & Symptom', '[System] + [Symptom]'), caption: 'System type plus the labor the reported symptom typically takes.' },
      { ...calc('Likely Repairs', '[Add-ons]'), caption: 'Repairs you flagged — confirmed before any work begins.' },
      { ...calc('Estimated Cost', '[Diagnostic & Trip] + [System & Symptom] + [Likely Repairs]'),
        resultMode: 'primary', caption: 'Your emergency estimate — the diagnostic fee is credited toward the repair.' },
    ],
    result_calc: 'Estimated Cost',
    results: {
      ...
      cta_heading: 'Same-day, around the clock',
      cta_sub: 'Request a tech now — NATE-certified, diagnostic credited to the repair, 1-year parts-and-labor warranty.',
      submit_success: 'Dispatching now — we will call to confirm your arrival window within minutes.',
  ...
  /* ── 35. Web design quote ── */
  {
    ...
    // Showcase style — modern indigo-and-slate studio palette, deep ink result
    // panel, violet CTA. Scope + tier drive wide variance → range on. Never
    // falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#6366f1',
    ...
    steps: [
      { id: 'step_scope', label: 'Scope & tier', help: 'Page count and design tier set the build base.', fields: ['pages', 'tier'] },
      { id: 'step_features', label: 'Features & timing', help: 'The functionality you need and how fast you need it live.', fields: ['features', 'turnaround'] },
    ],
    fields: [
      { id: 'pages', name: 'Pages', label: 'Number of pages', type: 'slider',
        min: 1, max: 50, step: 1, default_value: 8, unit: 'pages',
        help: 'Count each unique layout — a typical small-business site runs 5-12 pages.' },
      // Highest-uncertainty question. Kept as a descriptive text radio: stock
      // photos can't honestly distinguish "template" from "custom" design tiers,
      // so each option carries a clear plain-language description instead.
      { id: 'tier', name: 'Design Tier', label: 'Design tier', type: 'radio',
        help: 'Custom design is the most-chosen — it is built around your brand, not a stock theme.',
        options: [
          { ...opt('Template-based', 1.0), description: 'A polished premium theme tailored to your brand — fastest and most affordable.' },
          { ...opt('Custom design', 1.8), description: 'Designed from scratch to your brand — our most popular tier.' },
          { ...opt('Premium custom + branding', 2.8), description: 'Full brand system plus bespoke design and motion — flagship work.' },
        ] },
      { id: 'features', name: 'Features', label: 'Features to include', type: 'multi_select',
        help: 'Add only what you need now — we can phase the rest in later.',
      ...
      { id: 'turnaround', name: 'Turnaround', label: 'Project turnaround', type: 'select',
        help: 'Faster timelines add a priority surcharge to reshuffle our build queue.',
        options: [opt('Standard (6-8 weeks)', 1.0), opt('Fast (3-4 weeks)', 1.25), opt('Rush (2 weeks)', 1.55)] },
    ],
    calculations: [
      { ...calc('Design & Build', '[Pages] * 280 * [Design Tier] * [Turnaround]'), caption: 'Per-page design and build, scaled by tier and timeline.' },
      { ...calc('Custom Features', '[Features]'), caption: 'The functionality you selected.' },
      { ...calc('Estimated Project Cost', '[Design & Build] + [Custom Features]'),
        resultMode: 'primary', caption: 'Your fixed project estimate — confirmed on a free strategy call before you commit.' },
    ],
    result_calc: 'Estimated Project Cost',
    results: {
      ...
      cta_heading: '200+ sites launched, fixed pricing',
      cta_sub: 'Book a free strategy call — we scope your site, lock a fixed price, and include 3 rounds of revisions.',
      submit_success: 'Booked! We will confirm your strategy-call time and send a short questionnaire to prep.',
  ...
  /* ── 36. Photography package ── */
  {
    ...
    // Showcase style — editorial rose-and-charcoal studio palette, deep plum
    // result panel, magenta CTA. Shoot type + deliverables drive variance →
    // range on. Never falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#be185d',
    ...
    steps: [
      { id: 'step_shoot', label: 'Shoot & hours', help: 'What the shoot is for and how long sets the session base.', fields: ['event_type', 'hours'] },
      { id: 'step_delivery', label: 'Deliverables & crew', help: 'What you take home, plus an optional second photographer.', fields: ['deliverables', 'second_shooter'] },
    ],
    fields: [
      // Image-card radio on the highest-uncertainty question (shoot type).
      { id: 'event_type', name: 'Event Type', label: 'What\'s the shoot for?', type: 'radio',
        help: 'Pick the closest match — it sets the base session rate and the gear we bring.',
        options: [
          { ...optImg('Portrait session', 250, '/template-images/photo-portrait.jpg'),
            description: 'Headshots or personal portraits — studio or on-location.' },
          { ...optImg('Family / lifestyle', 380, '/template-images/photo-family-lifestyle.jpg'),
            description: 'Relaxed, candid sessions for families and couples.' },
          { ...optImg('Corporate event', 850, '/template-images/photo-corporate-event.jpg'),
            description: 'Conferences, launches and team events with fast turnaround.' },
          { ...optImg('Wedding', 2400, '/template-images/photo-wedding.jpg'),
            description: 'Full-day coverage of your ceremony and reception.' },
          { ...optImg('Real estate listing', 320, '/template-images/photo-real-estate.jpg'),
            description: 'Bright, wide listing photos that sell the property.' },
          { ...optImg('Product / e-commerce', 480, '/template-images/photo-product-ecommerce.jpg'),
            description: 'Clean catalogue shots on white or styled scenes.' },
        ] },
      { id: 'hours', name: 'Hours', label: 'Hours of coverage', type: 'number',
        min: 1, max: 12, step: 1, default_value: 4, unit: 'hr',
        help: 'How long you need the photographer on site — most portrait sessions run 1-2 hours.' },
      { id: 'deliverables', name: 'Deliverables', label: 'Deliverables', type: 'multi_select',
        help: 'The edited gallery is always included — add prints, video or RAW files as you like.',
      ...
      { id: 'second_shooter', name: 'Second Shooter', label: 'Add a second photographer', type: 'toggle', on_value: 550,
        help: 'A second shooter captures more angles and reaction shots — recommended for weddings.' },
    ],
    calculations: [
      { ...calc('Session Base', '[Event Type] + [Hours] * 90'), caption: 'Your shoot type plus on-site coverage hours.' },
      { ...calc('Deliverables', '[Deliverables]'), caption: 'The prints, video and files you selected.' },
      { ...calc('Second Photographer', '[Second Shooter]'), caption: 'An optional second shooter for more coverage.' },
      { ...calc('Estimated Quote', '[Session Base] + [Deliverables] + [Second Photographer]'),
        resultMode: 'primary', caption: 'Your package price — a 25% deposit holds your date, refundable up to 60 days out.' },
    ],
    result_calc: 'Estimated Quote',
    results: {
      ...
      cta_heading: '4.9★ from 400+ clients',
      cta_sub: 'Reserve your date with a refundable deposit. Love your gallery or your money back — guaranteed.',
      submit_success: 'Reserved! We will confirm your date and send a short shot-list questionnaire to plan the session.',
  ...
  /* ── 37. Moving service ── */
  {
    ...
    fields: [
      ...
      { id: 'home_size', name: 'Home Size', label: 'Home size', type: 'radio',
        ...
        options: [
          { ...optImg('Studio / 1 bed', 1.0, '/template-images/move-studio.jpg'),
            description: 'Up to ~600 sqft — fits a single truck load.' },
          { ...optImg('2 bedroom', 1.5, '/template-images/move-2bed.jpg'),
            description: 'Typical apartment or small house.' },
          { ...optImg('3 bedroom', 2.1, '/template-images/move-3bed.jpg'),
            description: 'Full household — our most common move.' },
          { ...optImg('4+ bedroom', 2.8, '/template-images/move-4bed.jpg'),
  ...
  /* ── 38. Home inspection ── */
  {
    ...
    // Showcase style — trustworthy slate-blue inspector palette, deep navy
    // result panel, sky-blue CTA. Per-sqft inspection pricing is exact →
    // range off. Never falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#0369a1',
    ...
    steps: [
      { id: 'step_home', label: 'Home size & age', help: 'Square footage and age set the base inspection time.', fields: ['sqft', 'age'] },
      { id: 'step_tests', label: 'Tests & turnaround', help: 'Specialty add-on tests and how fast you need the report.', fields: ['addons', 'turnaround'] },
    ],
    fields: [
      { id: 'sqft', name: 'Home Size', label: 'Home size (sqft)', type: 'slider',
        min: 600, max: 8000, step: 100, default_value: 2200, unit: 'sqft',
        help: 'From the listing is fine — most single-family homes run 1,500-3,000 sqft.' },
      { id: 'age', name: 'Home Age', label: 'Home age', type: 'select',
        help: 'Older homes take longer to inspect — more systems to check and document.',
      ...
      { id: 'addons', name: 'Add-on Tests', label: 'Specialty add-on tests', type: 'multi_select',
        help: 'Radon and sewer-scope are the most-requested for older homes — add only what applies.',
      ...
      // Highest-uncertainty categorical. Kept as a descriptive text radio:
      // turnaround speed isn't a photo decision, so each tier carries a clear
      // plain-language description instead of a stock image.
      { id: 'turnaround', name: 'Turnaround', label: 'Report turnaround', type: 'radio',
        help: 'On a tight closing timeline? Rush and same-day reports move you to the front of the queue.',
        options: [
          { ...opt('Standard (48 hours)', 0), description: 'Full report within two business days — best price.' },
          { ...opt('Rush (next business day)', 95), description: 'Report by the next business day for tighter timelines.' },
          { ...opt('Same-day report', 180), description: 'Same-evening report when your offer deadline is hours away.' },
        ] },
    ],
    calculations: [
      { ...calc('Base Inspection', '[Home Size] * 0.18 * [Home Age]'), caption: 'Per-sqft inspection scaled by the home\'s age.' },
      { ...calc('Specialty Tests', '[Add-on Tests]'), caption: 'The add-on tests you selected.' },
      { ...calc('Rush Report', '[Turnaround]'), caption: 'Any priority report turnaround.' },
      { ...calc('Estimated Quote', '[Base Inspection] + [Specialty Tests] + [Rush Report]'),
        resultMode: 'primary', caption: 'Your inspection price — full 400+ item report and inspector walk-through included.' },
    ],
    result_calc: 'Estimated Quote',
    results: {
      ...
      cta_heading: 'InterNACHI-certified, 2,000+ homes',
      cta_sub: 'Book an independent inspector — full photo report, on-site walk-through, and buy-back guarantee available.',
      submit_success: 'Booked! We will confirm your inspection time and send a prep checklist for accessing the property.',
  ...
  /* ── 39. Solar panel installation ── */
  {
    ...
    // Showcase style — clean sky-and-gold solar palette, deep forest result
    // panel, sunlit-amber CTA. System size + battery drive variance →
    // range on. Never falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#0284c7',
    ...
    steps: [
      { id: 'step_system', label: 'System & roof', help: 'System size and roof type set the install base.', fields: ['system_size', 'roof_type'] },
      { id: 'step_storage', label: 'Storage & extras', help: 'Battery backup and any optional add-ons.', fields: ['battery', 'extras'] },
    ],
    fields: [
      { id: 'system_size', name: 'System Size', label: 'System size (kW)', type: 'slider',
        min: 3, max: 25, step: 0.5, default_value: 8.5, unit: 'kW',
        help: 'Not sure? An average home offsets its bill with 7-10 kW — we right-size it on the survey.' },
      // Image-card radio on the highest-uncertainty question (roof type).
      { id: 'roof_type', name: 'Roof Type', label: 'Roof type', type: 'radio',
        help: 'Roof material changes the mounting hardware and labor — pick what matches yours.',
        options: [
          { ...opt('Asphalt shingle', 1.0),
            description: 'The most common residential roof — straightforward standard mounting.' },
          { ...opt('Tile (clay / concrete)', 1.18),
            description: 'Clay or concrete tile — needs careful tile-hook mounting.' },
          { ...opt('Metal standing seam', 1.1),
            description: 'Standing-seam metal — clamp mounts, no roof penetrations.' },
          { ...opt('Flat / membrane', 1.12),
            description: 'Flat or low-slope roof — ballasted or tilt-up racking.' },
        ] },
      { id: 'battery', name: 'Battery Storage', label: 'Battery storage', type: 'radio',
        help: 'A battery keeps the lights on during outages and stores cheap daytime solar for night use.',
        options: [
          { ...opt('No battery', 0), description: 'Grid-tied only — lowest upfront cost.' },
          opt('Single battery (~13 kWh)', 12500),
          opt('Dual battery (~26 kWh)', 22500),
        ] },
      { id: 'extras', name: 'Extras', label: 'Optional extras', type: 'multi_select',
        help: 'Permit and interconnect handling is included free — add the rest only if you need it.',
    ...
    calculations: [
      { ...calc('Panel System', '[System Size] * 2800 * [Roof Type]'), caption: 'Panels, inverter and racking sized to your roof.' },
      { ...calc('Battery Storage', '[Battery Storage]'), caption: 'Optional backup battery storage.' },
      { ...calc('Optional Extras', '[Extras]'), caption: 'The add-ons you selected.' },
      { ...calc('Estimated System Cost', '[Panel System] + [Battery Storage] + [Optional Extras]'),
        resultMode: 'primary', caption: 'Your system price before incentives — the 30% federal credit applies on top.' },
    ],
    result_calc: 'Estimated System Cost',
    results: {
      ...
      cta_heading: '25-year warranty, 30% tax credit',
      cta_sub: 'Book a free site survey — NABCEP-certified installers right-size your system and file every incentive.',
      submit_success: 'Booked! We will confirm your site-survey time and prep your federal and utility incentive paperwork.',
  ...
  /* ── 40. Pool service ── */
  {
    ...
    // Showcase style — crisp aqua-and-white pool palette, deep teal result
    // panel, cyan CTA. Per-visit pricing is exact → range off. Never falls
    // back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#0891b2',
    ...
    steps: [
      { id: 'step_pool', label: 'Pool & cadence', help: 'Pool size and how often we visit set the per-visit base.', fields: ['pool_size', 'frequency'] },
      { id: 'step_service', label: 'Service & chemicals', help: 'What we do each visit, plus who supplies the chemicals.', fields: ['services', 'chemicals'] },
    ],
    fields: [
      { id: 'pool_size', name: 'Pool Size', label: 'Pool size', type: 'select',
        help: 'A rough gallon estimate is fine — most residential pools fall in the small-to-medium range.',
        options: [opt('Small (under 15,000 gal)', 1.0), opt('Medium (15-25,000 gal)', 1.3), opt('Large (25,000+ gal)', 1.7)] },
      // Highest-uncertainty categorical (the recurring-plan choice). Kept as a
      // descriptive text radio — cadence isn't a photo decision, so each option
      // explains who it suits instead of carrying a stock image.
      { id: 'frequency', name: 'Frequency', label: 'How often do you want service?', type: 'radio',
        help: 'Weekly keeps water consistently balanced; bi-weekly suits lightly-used pools.',
        options: [
          { ...opt('Weekly', 1.0), description: 'Always swim-ready — best for heavy use and summer.' },
          { ...opt('Bi-weekly', 0.55), description: 'A solid middle ground for moderately-used pools.' },
          { ...opt('Monthly', 0.30), description: 'Light upkeep for low-use or off-season pools.' },
        ] },
      { id: 'services', name: 'Services', label: 'Included per visit', type: 'multi_select',
        help: 'Pick what you want done each visit — skim, brush and chemistry are the core three.',
      ...
      { id: 'chemicals', name: 'Chemicals', label: 'Chemical supply', type: 'radio',
        help: 'We can bring and dose everything, or work with chemicals you already keep on hand.',
        options: [opt('You supply', 0), opt('We supply standard', 45), opt('We supply premium (saltwater / mineral)', 75)] },
    ],
    calculations: [
      { ...calc('Service & Cleaning', '[Services] * [Pool Size] * [Frequency]'), caption: 'Your per-visit tasks scaled by pool size and cadence.' },
      { ...calc('Chemicals', '[Chemicals]'), caption: 'Chemical supply, if you want us to bring it.' },
      { ...calc('Per-Visit Cost', '[Service & Cleaning] + [Chemicals]'),
        resultMode: 'primary', caption: 'Your per-visit price — pre-pay a full season and save 10%.' },
    ],
    result_calc: 'Per-Visit Cost',
    results: {
      ...
      cta_heading: 'CPO-certified, equipment included',
      cta_sub: 'Start recurring service — all gear included, pre-pay the season for 10% off, cancel anytime with 30 days notice.',
      submit_success: 'You\'re set! We will confirm your first visit and assign a dedicated CPO-certified tech to your pool.',
  ...
  /* ── 41. Pest control ── */
  {
    ...
    // Showcase style — clean green-and-white family-safe palette, deep moss
    // result panel, lime CTA. Per-sqft treatment pricing is exact → range
    // off. Never falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#15803d',
    ...
    steps: [
      { id: 'step_home', label: 'Home & plan', help: 'Home size and your plan set the treatment base.', fields: ['home_size', 'plan'] },
      { id: 'step_target', label: 'Pests & scope', help: 'What we are treating and where we treat.', fields: ['pests', 'scope'] },
    ],
    fields: [
      { id: 'home_size', name: 'Home Size', label: 'Home size (sqft)', type: 'slider',
        min: 600, max: 6000, step: 100, default_value: 2000, unit: 'sqft',
        help: 'A rough size is fine — it sets how much area we treat inside and around the home.' },
      // Highest-uncertainty categorical (the recurring-plan choice). Kept as a
      // descriptive text radio — a service cadence isn't a photo decision, so
      // each option explains who it suits.
      { id: 'plan', name: 'Plan', label: 'Service plan', type: 'radio',
        help: 'Quarterly is our most-chosen — it keeps a protective barrier up year-round.',
        options: [
          { ...opt('One-time treatment', 1.0), description: 'A single targeted visit for an immediate problem.' },
          { ...opt('Quarterly (recommended)', 0.40), description: 'Year-round protection with free re-treatments between visits.' },
          { ...opt('Monthly (heavy issue)', 0.18), description: 'Intensive cadence for active infestations.' },
        ] },
      { id: 'pests', name: 'Pests', label: 'What are we treating?', type: 'multi_select',
        help: 'Select everything you have seen — we tailor the products and traps to each one.',
      ...
      { id: 'scope', name: 'Scope', label: 'Treatment scope', type: 'select',
        help: 'Full perimeter — interior plus exterior — gives the most complete protection.',
        options: [opt('Interior only', 0), opt('Exterior only', 0), opt('Interior + exterior (full perimeter)', 60)] },
    ],
    calculations: [
      { ...calc('Treatment Base', '[Home Size] * 0.06 * [Plan]'), caption: 'Per-sqft treatment scaled by your service plan.' },
      { ...calc('Target Pests', '[Pests]'), caption: 'Targeted treatment for the pests you selected.' },
      { ...calc('Treatment Scope', '[Scope]'), caption: 'Interior, exterior or full-perimeter coverage.' },
      { ...calc('Estimated Cost', '[Treatment Base] + [Target Pests] + [Treatment Scope]'),
        resultMode: 'primary', caption: 'Your treatment price — quarterly plans include free re-treatment if pests return.' },
    ],
    result_calc: 'Estimated Cost',
    results: {
      ...
      cta_heading: 'Family- and pet-safe, guaranteed',
      cta_sub: 'Schedule a licensed pro — kid- and pet-safe products, free re-treatments, and a 30-day satisfaction guarantee.',
      submit_success: 'Booked! We will confirm your treatment time and send prep tips so the visit goes smoothly.',
  ...
  /* ── 42. Roof replacement ── */
  {
    ...
    fields: [
      ...
      { id: 'material', name: 'Material', label: 'Which roofing material?', type: 'radio',
        ...
        options: [
          { ...optImg('Architectural shingle', 6.5, '/template-images/roof-architectural-shingle.jpg'),
            description: 'The US default — 30-year dimensional shingle, best value per year of life.' },
          { ...optImg('3-tab shingle', 4.5, '/template-images/roof-3tab-shingle.jpg'),
            description: 'Lowest upfront cost — flat profile, ~20-year life.' },
          { ...optImg('Metal standing seam', 11, '/template-images/roof-metal-standing-seam.jpg'),
            description: '50-year life, sheds snow, lowers cooling bills — higher upfront.' },
          { ...optImg('Clay tile', 14, '/template-images/roof-tile-clay.jpg'),
            description: 'Mediterranean look, lifetime material — needs reinforced framing.' },
          { ...optImg('Slate', 19, '/template-images/roof-slate.jpg'),
  ...
  /* ── 43. Garage door service ── */
  {
    ...
    fields: [
      { id: 'service', name: 'Service', label: 'What do you need?', type: 'radio',
        ...
        options: [
          { ...optImg('Repair only', 180, '/template-images/garage-repair.jpg'),
            description: 'Fix a broken spring, cable, roller or panel.' },
          { ...optImg('New door install', 1400, '/template-images/garage-new-door.jpg'),
            description: 'Brand-new door fitted to your existing opener.' },
          { ...optImg('Door + opener replacement', 2200, '/template-images/garage-door-opener.jpg'),
  ...
  /* ── 44. Appliance repair ── */
  {
    ...
    // Showcase style — cool steel-blue tech palette, deep-slate result panel,
    // amber CTA. Diagnostic+parts pricing is approximate → range_mode on.
    // Never falls back to deriveStyleFromCategory.
    style: {
      widgetWidth: 'wide',
      accent: '#2563eb',
    ...
    steps: [
      { id: 'step_appliance', label: 'Your appliance', help: 'Which unit and how old it is sets the base diagnostic and labor.', fields: ['appliance', 'age'] },
      { id: 'step_problem', label: 'The problem', help: 'What it is doing now helps us bring the right parts on the first trip.', fields: ['symptom', 'parts'] },
    ],
    fields: [
      // Image-card radio on the highest-uncertainty question (which appliance).
      // Reuses proven shipped photo ids (kitchen/surface/cleaning subjects —
      // the closest category-adjacent imagery in the catalogue).
      { id: 'appliance', name: 'Appliance', label: 'Which appliance?', type: 'radio',
        help: 'Pick the unit that needs a fix — each one carries its own flat-rate diagnostic.',
        options: [
          { ...optImg('Refrigerator', 220, '/template-images/appl-refrigerator.jpg'),
            description: 'Cooling, ice-maker, water line and compressor faults.' },
          { ...optImg('Dishwasher', 180, '/template-images/appl-dishwasher.jpg'),
            description: 'Drainage, leaks, no-clean cycles and pump issues.' },
          { ...optImg('Washer / dryer', 195, '/template-images/appl-washer-dryer.jpg'),
            description: 'No-spin, no-heat, drum noise and drainage faults.' },
          { ...optImg('Range / oven', 210, '/template-images/appl-range-oven.jpg'),
            description: 'Burner, igniter, heating-element and thermostat faults.' },
          { ...optImg('Microwave', 145, '/template-images/appl-microwave.jpg'),
            description: 'No-heat, turntable and door-switch repairs.' },
          { ...optImg('Garbage disposal', 130, '/template-images/appl-garbage-disposal.jpg'),
            description: 'Jams, leaks, humming and reset-trip repairs.' },
        ] },
      { id: 'age', name: 'Age', label: 'Appliance age', type: 'radio',
        help: 'Older units take longer to source parts for, which nudges labor up.',
        options: [
          { ...opt('Under 5 years', 1.0), description: 'Modern parts, fast turnaround.' },
          opt('5-10 years', 1.15),
          opt('10+ years', 1.3),
        ] },
      { id: 'symptom', name: 'Symptom', label: 'What\'s the symptom?', type: 'select',
        help: 'A rough description is fine — it tells us what to test first.',
      ...
      { id: 'parts', name: 'Parts', label: 'Likely parts needed', type: 'radio',
        help: 'If you are not sure, leave it on diagnostic-only — we confirm before any parts cost.',
        options: [opt('Diagnostic only', 0), opt('Minor part — under $50', 60), opt('Major part — $50 to $200', 175), opt('OEM or specialty part — $200 plus', 320)] },
    ],
    calculations: [
      { ...calc('Diagnostic & Labor', '[Appliance] * [Age]'), caption: 'Flat-rate diagnostic and labor for your appliance and its age.' },
      { ...calc('Symptom Surcharge', '[Symptom]'), caption: 'Extra time the reported symptom typically takes to fix.' },
      { ...calc('Parts', '[Parts]'), caption: 'Estimated parts — confirmed on-site before anything is ordered.' },
      { ...calc('Estimated Cost', '[Diagnostic & Labor] + [Symptom Surcharge] + [Parts]'),
        resultMode: 'primary', caption: 'Your repair estimate — the diagnostic fee is credited when we do the fix same visit.' },
    ],
    result_calc: 'Estimated Cost',
    results: {
      ...
      show_breakdown: true,
      cta_label: 'Book a Repair',
      cta_heading: 'Most repairs done in one visit',
      cta_sub: 'Pick a time — factory-trained techs, flat-rate pricing, no surprise add-ons.',
      submit_success: 'Booked! We will confirm your repair window and the tech assigned shortly.',
  ...
  /* ── 45. Junk Removal (sample — W-AH-1, styled — W-AS-1) ── */
  {
    ...
    steps: [
      { id: 'step_load', label: 'The load', help: 'How much junk you have is the biggest price driver — pick the closest truck fill.', fields: ['load_size', 'mattresses', 'appliances'] },
      { id: 'step_access', label: 'Access & timing', help: 'Stairs, drop-off distance and same-day pickup are priced on top.', fields: ['stairs', 'distance', 'same_day'] },
    ],
    fields: [
      ...
      { id: 'load_size', name: 'Load Size', label: 'How much junk do you have?', type: 'radio',
        help: 'Picture our truck filling up — pick the closest fraction; we confirm on arrival.',
        options: [
          { ...optImg('1/4 truck', 120, '/template-images/load-quarter-truck.jpg'),
            description: 'A few large items or a small pile — about a pickup-bed load.' },
          { ...optImg('1/2 truck', 220, '/template-images/load-half-truck.jpg'),
            description: 'One room cleared out, or a garage corner.' },
          optImg('3/4 truck', 320, '/template-images/load-three-quarter-truck.jpg'),
          optImg('Full truck', 425, '/template-images/load-full-truck.jpg'),
        ] },
      { id: 'mattresses', name: 'Mattresses', label: 'Mattresses', type: 'number',
        min: 0, max: 5, step: 1, default_value: 1, unit: 'item',
        help: 'Mattresses and box springs are recycled separately, so we count them.' },
      { id: 'appliances', name: 'Appliances', label: 'Appliances (fridge, washer, etc.)', type: 'number',
        min: 0, max: 5, step: 1, default_value: 1, unit: 'item',
        help: 'Fridges, washers and other large appliances carry a disposal fee each.' },
      { id: 'stairs', name: 'Stairs', label: 'Items located up or down stairs', type: 'toggle', on_value: 50,
        help: 'Turn on if items are above the ground floor or down to a basement.' },
      { id: 'distance', name: 'Distance', label: 'Distance to drop-off (miles)', type: 'slider',
        min: 0, max: 30, step: 1, default_value: 8, unit: 'miles',
        help: 'How far we haul to the recycling or transfer site — a rough number is fine.' },
      { id: 'same_day', name: 'Same-day pickup', label: 'Same-day pickup', type: 'toggle', on_value: 75,
        help: 'Need it gone today? We prioritize your job for a flat rush fee.' },
    ],
    calculations: [
      { ...calc('Load & Items', '[Load Size] + [Mattresses] * 25 + [Appliances] * 45'), caption: 'Truck-fill rate plus per-item disposal for mattresses and appliances.' },
      { ...calc('Access & Distance', '[Stairs] + [Distance] * 2'), caption: 'Stair carry-out and haul distance to the drop-off site.' },
      { ...calc('Same-day Pickup', '[Same-day pickup]'), caption: 'Optional same-day rush.' },
      { ...calc('Total Removal Cost', '[Load & Items] + [Access & Distance] + [Same-day Pickup]'),
        resultMode: 'primary', caption: 'Your all-in removal price — labor, disposal and clean-up included.' },
    ],
    ...
    results: {
      ...
      cta_heading: 'We load it, haul it, sweep up',
      cta_sub: 'Pick a window — most items donated or recycled, with same-day pickup available.',
      submit_success: 'Booked! We will confirm your pickup window and arrival time shortly.',
   ...
   * their existing styling — Phase 2 rolls the rule across the catalogue. */
  {
    ...
    fields: [
      { id: 'count', name: 'Count', label: 'Number of windows', type: 'number',
        ...
        help: 'Count every window you want replaced — a typical home replaces 8-12 at once.' },
      // BD-2c — converted from `select` to `radio` with image cards.
      { id: 'type', name: 'Type', label: 'Window type', type: 'radio',
        help: 'Pick the style that matches most of your windows — we confirm each at the free measurement.',
        options: [
          ...
          // the same ORB policy.
          { ...optImg('Single hung', 250, '/template-images/window-single-hung.jpg'),
            description: 'Bottom sash slides up — the most affordable, common in older homes.' },
          { ...optImg('Double hung', 320, '/template-images/window-double-hung.jpg'),
            description: 'Both sashes move and tilt in for easy cleaning — the popular choice.' },
          { ...optImg('Sliding', 290, '/template-images/window-sliding.jpg'),
            description: 'Glides side-to-side — great for wide openings over counters.' },
          { ...optImg('Picture', 410, '/template-images/window-picture.jpg'),
            description: 'A large fixed pane for maximum light and an unbroken view.' },
          { ...optImg('Bay', 780, '/template-images/window-bay.jpg'),
            description: 'A projecting multi-panel window that adds light and a sill nook.' },
        ] },
      { id: 'frame', name: 'Frame', label: 'Frame material', type: 'select',
        help: 'Vinyl is the value pick; fiberglass and wood add durability and a premium look.',
        options: [opt('Vinyl', 0), opt('Fiberglass', 110), opt('Wood', 180), opt('Aluminum', 60)] },
      { id: 'glass', name: 'Glass', label: 'Glass package', type: 'select',
        help: 'Low-E glass cuts energy bills; triple-pane adds the most insulation and sound-blocking.',
      ...
      { id: 'install', name: 'Professional installation per window', label: 'Pro installation per window', type: 'toggle', on_value: 145,
        help: 'Certified installation protects your lifetime warranty and the airtight seal.' },
      { id: 'disposal', name: 'Haul away old windows', label: 'Haul away the old windows', type: 'toggle', on_value: 60,
        help: 'We remove and responsibly dispose of your old windows so you don\'t have to.' },
    ],
    calculations: [
      { ...calc('Windows & Installation', '[Count] * ([Type] + [Frame] + [Glass] + [Professional installation per window])'),
        caption: 'Each window\'s type, frame, glass and install, across your count.' },
      { ...calc('Removal & Disposal', '[Haul away old windows]'), caption: 'Optional haul-away of the old windows.' },
      { ...calc('Total Window Replacement', '[Windows & Installation] + [Removal & Disposal]'),
        resultMode: 'primary', caption: 'Your installed price — confirmed at a free in-home measurement, locked for 30 days.' },
    ],
    ...
    results: {
      ...
      cta_heading: 'ENERGY STAR windows, lifetime warranty',
      cta_sub: 'Book a free in-home measurement — certified installers, lifetime product warranty, and a price locked for 30 days.',
      submit_success: 'Booked! We will confirm your measurement appointment and bring frame and glass samples to compare.',
   ...
   * panel collapses below inputs at ≤768px (renderer-handled). */
  {
    ...
    steps: [
      { id: 'step_area', label: 'Area', help: 'Room size and how many rooms set the per-sqft base.', fields: ['room_size', 'rooms'] },
      { id: 'step_extras', label: 'Add-ons', help: 'Optional treatments to finish the job.', fields: ['extras'] },
    ],
    fields: [
      { id: 'room_size', name: 'Room Size', label: 'Room Size (sq ft)', type: 'slider',
        min: 100, max: 500, step: 10, default_value: 250, unit: 'sq ft',
        help: 'A rough size per room is fine — an average bedroom or living room is about 200-300 sq ft.' },
      { id: 'rooms', name: 'Number of Rooms', label: 'Number of Rooms', type: 'slider',
        min: 1, max: 10, step: 1, default_value: 1, unit: 'rooms',
        help: 'How many carpeted rooms you want cleaned — hallways and stairs count as one room.' },
      { id: 'extras', name: 'Additional Services', label: 'Additional Services', type: 'multi_select',
        help: 'Add stain removal for problem spots, or Scotchgard to keep carpets cleaner longer.',
        options: [
          { ...opt('Stain Removal', 25), description: 'Targeted treatment for set-in spots and high-traffic lanes.' },
          opt('Deodorizing', 15),
    ...
    calculations: [
      ...
      { ...calc('Cost per Room', 'ROUND([Room Size] * 0.5, 2)'), caption: 'Per-room cleaning at $0.50 per square foot.' },
      { ...calc('Total Cost', '[Cost per Room] * [Number of Rooms] + [Additional Services]'),
        resultMode: 'primary', caption: 'Your all-in carpet cleaning price — confirmed when our technician arrives.' },
    ],
    ...
    results: {
      ...
      show_breakdown: true,
      cta_label: 'Book Now',
      cta_heading: 'IICRC-certified, eco-friendly clean',
      cta_sub: 'Book your appointment today — certified technicians, eco-friendly products, and satisfaction guaranteed.',
      submit_success: 'Booked! We will confirm your appointment time and send a quick prep checklist before we arrive.',
  ...
  /* ── 47. Mold Remediation (sample — W-AH-1, styled — W-AS-1) ── */
  {
    ...
    steps: [
      { id: 'step_scope', label: 'Scope', help: 'Affected area and how bad the mold is set the bulk of the cost.', fields: ['area', 'severity', 'mold_type'] },
      { id: 'step_protocol', label: 'Protocol & timing', help: 'Containment, HVAC, clearance testing and how fast you need us.', fields: ['containment', 'hvac', 'post_test', 'urgency'] },
    ],
    fields: [
      { id: 'area', name: 'Area', label: 'Affected area (sqft)', type: 'slider',
        min: 10, max: 2000, step: 10, default_value: 80, unit: 'sqft',
        help: 'A rough size of the visibly affected area — we confirm the full extent on inspection.' },
      ...
      { id: 'severity', name: 'Severity', label: 'Mold severity', type: 'radio',
        help: 'Surface mold wipes away; subsurface and structural mold need removal of materials.',
        options: [
          { ...optImg('Surface mold — visible only', 8, '/template-images/mold-surface.jpg'),
            description: 'Visible growth on a non-porous surface — cleanable without demolition.' },
          { ...optImg('Moderate — subsurface, no structural', 14, '/template-images/mold-moderate.jpg'),
            description: 'Behind paint or drywall, but the framing is sound.' },
          { ...optImg('Severe — structural damage', 26, '/template-images/mold-severe.jpg'),
            description: 'Mold into framing or subfloor — materials must be removed and rebuilt.' },
        ] },
      { id: 'mold_type', name: 'Mold Type', label: 'Mold type (if known)', type: 'select',
        help: 'Leave on the common option if you are not sure — we lab-test to confirm.',
      ...
      { id: 'containment', name: 'Containment & negative-air setup required', label: 'Add containment & negative-air setup', type: 'toggle', on_value: 800,
        help: 'Sealed zones and negative-air machines stop spores spreading during removal.' },
      { id: 'hvac', name: 'HVAC/ductwork remediation', label: 'Include HVAC & ductwork remediation', type: 'toggle', on_value: 650,
        help: 'Cleans contaminated ducts so the system does not re-spread spores.' },
      { id: 'post_test', name: 'Third-party air-quality test after remediation', label: 'Independent air-quality clearance test', type: 'toggle', on_value: 425,
        help: 'An independent lab confirms the air is clear — recommended for resale and insurance.' },
      // show_if — a containment requirement is the norm once mold is structural,
      // so surface emergencies that pair clearance testing also get a clear cue.
      { id: 'urgency', name: 'Urgency', label: 'How urgent is it?', type: 'select',
        help: 'Faster scheduling pulls a crew off the queue — pick what fits your situation.',
        options: [opt('Standard scheduling', 0), opt('Within 48 hours', 350), opt('Emergency — 24h', 900)] },
    ],
    calculations: [
      { ...calc('Remediation & Materials', '[Area] * [Severity] + [Mold Type]'), caption: 'Area-based removal scaled by severity, plus any specialty mold handling.' },
      { ...calc('Containment & HVAC', '[Containment & negative-air setup required] + [HVAC/ductwork remediation]'), caption: 'Optional containment, negative-air and duct remediation.' },
      { ...calc('Testing & Urgency', '[Third-party air-quality test after remediation] + [Urgency]'), caption: 'Independent clearance testing and any rush scheduling.' },
      { ...calc('Total Remediation Cost', '[Remediation & Materials] + [Containment & HVAC] + [Testing & Urgency]'),
        resultMode: 'primary', caption: 'Your remediation estimate — lab analysis and written clearance included.' },
    ],
    ...
    results: {
      ...
      show_breakdown: true,
      cta_label: 'Schedule Inspection',
      cta_heading: 'EPA-protocol removal, written clearance',
      cta_sub: 'Book an inspection — IICRC-certified, with lab analysis and insurance documentation on every job.',
      submit_success: 'Booked! We will confirm your inspection time and arrival window shortly.',
   ...
   */
  {
    ...
    fields: [
      ...
      { id: 'move_size', name: 'Move Size', label: 'How big is your move?', type: 'radio',
        ...
        options: [
          { ...optImg('Studio / 1 bedroom', 0, '/template-images/move-studio.jpg'),
            description: 'Up to ~600 sqft — fits a single truck load.' },
          { ...optImg('2 bedroom', 150, '/template-images/move-2bed.jpg'),
            description: 'Typical apartment or small house.' },
          { ...optImg('3 bedroom', 320, '/template-images/move-3bed.jpg'),
            description: 'Full household — most popular size.' },
          { ...optImg('4+ bedroom', 540, '/template-images/move-4bed.jpg'),
            description: 'Large home — may need a second truck.' },
        ] },
   ...
   */
  {
    ...
    fields: [
      ...
      { id: 'placement', name: 'Placement', label: 'Where should it go?', type: 'radio',
        ...
        options: [
          { ...optImg('Driveway', 0, '/template-images/dumpster-driveway.jpg'),
            description: 'Boards under the rails protect your surface.' },
          optImg('Street / curb (permit)', 75, '/template-images/dumpster-street.jpg'),
          optImg('Yard or lot', 40, '/template-images/dumpster-yard.jpg'),
        ] },
   ...
   * schedule-driven replacements) so both are enabled in the style block. */
  {
    ...
    fields: [
      ...
      { id: 'wh_type', name: 'Heater Type', label: 'Which style of water heater?', type: 'radio',
        ...
        options: [
          { ...optImg('Standard tank', 1150, '/template-images/wh-standard-tank.jpg'),
            description: 'Familiar 40–75 gal storage tank — lowest installed cost.' },
          { ...optImg('Tankless on-demand', 2950, '/template-images/wh-tankless.jpg'),
   ...
   * sizing only surfaces on the propane fuel branch (show_if). */
  {
    ...
    fields: [
      ...
      { id: 'gen_kw', name: 'Generator Size', label: 'How much of the house should it run?', type: 'radio',
        ...
        options: [
          { ...optImg('10 kW — essentials', 6400, '/template-images/gen-10kw.jpg'),
            description: 'Fridge, furnace, well pump and lights.' },
          { ...optImg('14 kW — most homes', 8200, '/template-images/gen-14kw.jpg'),
            description: 'Adds AC and kitchen circuits — our most-installed size.' },
          { ...optImg('22 kW — whole home', 10900, '/template-images/gen-22kw.jpg'),
            description: 'Runs everything, including central air.' },
          { ...optImg('26 kW plus — large home', 13600, '/template-images/gen-26kw.jpg'),
   ...
   * (show_if contains). Monitoring select carries per-option descriptions. */
  {
    ...
    fields: [
      ...
      { id: 'sec_type', name: 'System Type', label: 'Which system style fits your home?', type: 'radio',
        ...
        options: [
          { ...optImg('Wired 4K PoE', 420, '/template-images/sec-wired-4k.jpg'),
            description: 'Sharpest video, 24/7 local recording — needs cable runs.' },
          { ...optImg('Wireless Wi-Fi', 180, '/template-images/sec-wireless-wifi.jpg'),
            description: 'Fastest install and easy to expand — battery or plug-in.' },
          { ...optImg('Mixed wired + wireless', 320, '/template-images/sec-mixed.jpg'),
   ...
   * the repair branch. */
  {
    ...
    fields: [
      ...
      { id: 'sep_service', name: 'Service Needed', label: 'What does your septic system need?', type: 'radio',
        ...
        options: [
          { ...optImg('Tank pumping', 345, '/template-images/septic-tank-pumping.jpg'),
            description: 'Full pump-out & licensed disposal — recommended every 3–5 years.' },
          { ...optImg('Inspection with camera', 425, '/template-images/septic-camera-inspection.jpg'),
            description: 'Point-of-sale or routine — written report with photos.' },
          { ...optImg('Repair visit', 285, '/template-images/septic-repair.jpg'),
   ...
   * (show_if against a toggle: value 1 = on). */
  {
    ...
    fields: [
      ...
      { id: 'duct_condition', name: 'Duct Condition', label: 'How dirty are the ducts?', type: 'radio',
        ...
        options: [
          { ...optImg('Routine refresh', 0, '/template-images/duct-routine.jpg'),
            description: 'Cleaned within ~5 years — standard agitation pass.' },
          { ...optImg('Heavy buildup', 110, '/template-images/duct-heavy.jpg'),
            description: 'Never cleaned, pets, or visible dust plumes from vents.' },
          { ...optImg('Post-renovation dust', 190, '/template-images/duct-post-reno.jpg'),
   ...
   * Range mode — slab condition isn't fully known until grinding starts. */
  {
    ...
    fields: [
      ...
      { id: 'gfc_finish', name: 'Finish Tier', label: 'Which finish do you want?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Solid color', 3, '/template-images/garage-floor-solid.jpg'),
            description: 'One-coat solid epoxy — clean, budget-friendly garage finish.' },
          { ...optImg('Decorative flake', 5, '/template-images/garage-floor-flake.jpg'),
            description: 'Broadcast color flake in a clear topcoat — hides cracks, best-seller.' },
          { ...optImg('Metallic epoxy', 8, '/template-images/garage-floor-metallic.jpg'),
   ...
   * (collapse is name-keyed). Range mode — sub-base condition varies. */
  {
    ...
    fields: [
      ...
      { id: 'asp_service', name: 'Service Type', label: 'What does your driveway need?', type: 'image_choice',
        ...
        options: [
          { ...optImg('New asphalt paving', 7, '/template-images/asphalt-new-paving.jpg'),
            description: 'Tear-out and fresh hot-mix asphalt — priced per square foot.' },
          { ...optImg('Sealcoat & protect', 0.35, '/template-images/asphalt-sealcoat.jpg'),
   ...
   * multi_select (contains). Range mode — excavation/grade varies on site. */
  {
    ...
    fields: [
      ...
      { id: 'ppw_style', name: 'Paver Style', label: 'Which paver style?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Standard concrete paver', 14, '/template-images/paver-standard-concrete.jpg'),
            description: 'Classic interlocking pavers — durable and budget-friendly.' },
          { ...optImg('Tumbled / cobble', 18, '/template-images/paver-tumbled-cobble.jpg'),
            description: 'Old-world tumbled edges — soft, rounded, premium look.' },
          { ...optImg('Large-format porcelain', 24, '/template-images/paver-porcelain-large.jpg'),
   ...
   * Range mode — excavation + drainage depth vary on site. */
  {
    ...
    fields: [
      ...
      { id: 'rw_material', name: 'Wall Material', label: 'Which wall material?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Segmental block', 32, '/template-images/wall-segmental-block.jpg'),
            description: 'Engineered interlocking block — most popular, fastest to build.' },
          { ...optImg('Natural stone', 52, '/template-images/wall-natural-stone.jpg'),
            description: 'Hand-laid quarried stone — premium, organic look.' },
          { ...optImg('Pressure-treated timber', 24, '/template-images/wall-timber.jpg'),
   ...
   * zone-count being serviced. */
  {
    ...
    fields: [
      ...
      { id: 'irr_job', name: 'Job Type', label: 'What do you need done?', type: 'image_choice',
        ...
        options: [
          { ...optImg('New system install', 850, '/template-images/irrigation-new-system.jpg'),
            description: 'Full design and install — heads, valves, controller and backflow.' },
          { ...optImg('Repair / tune-up', 120, '/template-images/irrigation-repair.jpg'),
      ...
      { id: 'irr_controller', name: 'Controller', label: 'Which controller?', type: 'radio',
        ...
        options: [
          { ...optImg('Standard timer', 0, '/template-images/irrigation-standard-timer.jpg'),
            description: 'Reliable fixed-schedule timer — lowest up-front cost.' },
          { ...optImg('Smart Wi-Fi controller', 240, '/template-images/irrigation-smart-controller.jpg'),
   ...
   * gated on a different option value. Range mode — snowfall is unpredictable. */
  {
    ...
    fields: [
      ...
      { id: 'snow_plan', name: 'Plan Type', label: 'How do you want to pay?', type: 'radio',
        ...
        options: [
          { ...optImg('Per visit per storm', 75, '/template-images/snow-per-visit.jpg'),
            description: 'Pay only when it snows — billed per plow visit.' },
          { ...optImg('Seasonal contract', 0, '/template-images/snow-seasonal.jpg'),
   ...
   * multi_select). Takedown-included toggle. */
  {
    ...
    fields: [
      ...
      { id: 'hol_tier', name: 'Design Tier', label: 'Which design tier?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Classic warm white', 4, '/template-images/holiday-warm-white.jpg'),
            description: 'Clean single-color roofline — the timeless look.' },
          { ...optImg('Premium multi-element', 6, '/template-images/holiday-multi-element.jpg'),
            description: 'Roofline plus accents and color-matched clips.' },
          { ...optImg('Luxury full display', 9, '/template-images/holiday-luxury.jpg'),
   ...
   * Range mode — sub-base condition isn't known until excavation. */
  {
    ...
    fields: [
      ...
      { id: 'turf_grade', name: 'Turf Grade', label: 'Which turf grade?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Landscape grade', 9, '/template-images/turf-landscape.jpg'),
            description: 'Soft, natural-looking lawn turf — best all-round value.' },
          { ...optImg('Pet grade antimicrobial', 12, '/template-images/turf-pet.jpg'),
            description: 'Tighter weave with antimicrobial backing — built for pets.' },
          { ...optImg('Putting / sport grade', 15, '/template-images/turf-sport.jpg'),
   ...
   * Sump-pump add-on. Range mode — soil and structural variance is high. */
  {
    ...
    fields: [
      ...
      { id: 'fnd_problem', name: 'Problem Type', label: 'What are you seeing?', type: 'radio',
        ...
        options: [
          { ...optImg('Foundation cracks', 90, '/template-images/foundation-cracks.jpg'),
            description: 'Vertical or stair-step cracks — sealed and reinforced per linear foot.' },
          { ...optImg('Bowing / settling walls', 320, '/template-images/foundation-bowing.jpg'),
            description: 'Inward-bowing or settling walls — stabilized with piers or anchors.' },
          { ...optImg('Water intrusion / damp basement', 0, '/template-images/foundation-water-intrusion.jpg'),
   ...
   * service is an optional add-on. */
  {
    ...
    fields: [
      ...
      { id: 'vw_coverage', name: 'Coverage', label: 'What are you wrapping?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Full vehicle wrap', 2400, '/template-images/wrap-full.jpg'),
            description: 'Bumper-to-bumper colour change — the whole exterior in vinyl.' },
          { ...optImg('Partial / accent wrap', 1100, '/template-images/wrap-partial.jpg'),
            description: 'Hood, roof, mirrors or racing stripes — accent panels only.' },
          { ...optImg('Paint protection film front', 1600, '/template-images/wrap-ppf.jpg'),
   ...
   * and IR-ceramic tiers carry upsell descriptions. */
  {
    ...
    fields: [
      ...
      { id: 'wt_film', name: 'Film Tier', label: 'Which film tier?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Dyed film', 28, '/template-images/tint-dyed.jpg'),
            description: 'Classic look and glare control — the budget-friendly tier.' },
          { ...optImg('Ceramic film', 48, '/template-images/tint-ceramic.jpg'),
            description: 'Blocks far more heat and 99% UV without interfering with signals.' },
          { ...optImg('IR ceramic film', 65, '/template-images/tint-ir-ceramic.jpg'),
   ...
   * countUp + range mode on the per-turnover headline. */
  {
    ...
    fields: [
      ...
      { id: 'str_freq', name: 'Turnover Frequency', label: 'How often does it turn over?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Occasional a few turns a month', 1.0, '/template-images/str-occasional.jpg'),
            description: 'Pay-as-you-go per turnover — no commitment.' },
          { ...optImg('Weekly turnovers', 0.92, '/template-images/str-weekly.jpg'),
            description: 'Recurring weekly slot — 8% off every turnover.' },
          { ...optImg('High-volume multiple per week', 0.85, '/template-images/str-high-volume.jpg'),
   ...
   * toggle adds expedited turnaround. */
  {
    ...
    fields: [
      ...
      { id: 'srv_type', name: 'Survey Type', label: 'Which survey do you need?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Boundary survey', 110, '/template-images/survey-boundary.jpg'),
            description: 'Locates and marks your legal property lines and corners.' },
          { ...optImg('Topographic survey', 145, '/template-images/survey-topographic.jpg'),
            description: 'Maps elevations and contours for design and grading.' },
          { ...optImg('ALTA NSPS survey', 220, '/template-images/survey-alta.jpg'),
   ...
   * distance band (show_if) only when the customer wants come-to-you service. */
  {
    ...
    fields: [
      ...
      { id: 'mm_service', name: 'Service', label: 'What do you need?', type: 'image_choice',
        ...
        options: [
          { ...optImg('Diagnostic warning light', 95, '/template-images/mech-diagnostic.jpg'),
            description: 'On-site scan and inspection — the fee credits toward any repair we do.' },
          { ...optImg('Brakes pads & rotors', 320, '/template-images/mech-brakes.jpg'),
            description: 'Front or rear pads and rotors replaced in your driveway.' },
          { ...optImg('Battery alternator or starter', 260, '/template-images/mech-battery-alt.jpg'),
