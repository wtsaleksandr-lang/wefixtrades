...
async function main() {
  ...
  const TASK_TEMPLATES: Record<string, Array<{
    ...
    "adflow-starter": [
      { title: "Collect onboarding info & ad goals", sort_order: 1, default_priority: "high", default_handled_by: "internal", default_waiting_on: "client", is_recurring: false , sla_days: 2 },
      { title: "Brief white-label agency on campaign goals", sort_order: 2, default_priority: "high", default_handled_by: "internal", is_recurring: false , sla_days: 1 },
      { title: "Agency sets up ad account + conversion tracking", sort_order: 3, default_handled_by: "supplier", is_recurring: false , sla_days: 3 },
      { title: "Agency designs ad creatives & copy", sort_order: 4, default_handled_by: "supplier" , sla_days: 5 },
      { title: "Client approves creatives", sort_order: 5, default_waiting_on: "client" , sla_days: 3 },
      { title: "Launch campaigns (1 platform)", sort_order: 6, default_handled_by: "supplier" , sla_days: 2 },
      { title: "Weekly bid / audience optimization", sort_order: 7, default_handled_by: "supplier" , sla_days: 7 },
      { title: "Monthly performance report (internal QA)", sort_order: 8, default_handled_by: "internal", human_review_required: true , sla_days: 3 },
    ],
    "adflow-growth": [
      { title: "Collect onboarding info & ad goals", sort_order: 1, default_priority: "high", default_handled_by: "internal", default_waiting_on: "client", is_recurring: false , sla_days: 2 },
      { title: "Brief white-label agency on campaign goals", sort_order: 2, default_priority: "high", default_handled_by: "internal", is_recurring: false , sla_days: 1 },
      { title: "Agency sets up ad accounts + conversion tracking", sort_order: 3, default_handled_by: "supplier", is_recurring: false , sla_days: 3 },
      { title: "Agency designs ad creatives & copy (A/B pairs)", sort_order: 4, default_handled_by: "supplier" , sla_days: 5 },
      { title: "Client approves creatives", sort_order: 5, default_waiting_on: "client" , sla_days: 3 },
      { title: "Launch campaigns (Google + Meta)", sort_order: 6, default_handled_by: "supplier" , sla_days: 2 },
      { title: "Weekly optimization + creative refresh", sort_order: 7, default_handled_by: "supplier" , sla_days: 7 },
      { title: "A/B test analysis & winner rollout", sort_order: 8, default_handled_by: "supplier" , sla_days: 5 },
      { title: "Monthly performance report (internal QA + forward to client)", sort_order: 9, default_handled_by: "internal", human_review_required: true , sla_days: 3 },
    ],
    "adflow-pro": [
      { title: "Collect onboarding info & ad goals", sort_order: 1, default_priority: "high", default_handled_by: "internal", default_waiting_on: "client", is_recurring: false , sla_days: 2 },
      { title: "Brief white-label agency on multi-platform strategy", sort_order: 2, default_priority: "high", default_handled_by: "internal", is_recurring: false , sla_days: 1 },
      { title: "Agency sets up all ad accounts + advanced tracking", sort_order: 3, default_handled_by: "supplier", is_recurring: false , sla_days: 3 },
      { title: "Agency designs ad creatives & video assets", sort_order: 4, default_handled_by: "supplier" , sla_days: 5 },
      { title: "Client approves creatives", sort_order: 5, default_waiting_on: "client" , sla_days: 3 },
      { title: "Launch multi-platform campaigns (Google + Meta + YouTube)", sort_order: 6, default_handled_by: "supplier" , sla_days: 2 },
      { title: "Daily optimization + bid management", sort_order: 7, default_handled_by: "supplier" , sla_days: 7 },
      { title: "Weekly A/B test cycles + creative rotation", sort_order: 8, default_handled_by: "supplier" , sla_days: 7 },
      { title: "Landing page conversion optimization", sort_order: 9, default_handled_by: "supplier" , sla_days: 5 },
      { title: "Bi-weekly performance review call with client", sort_order: 10, default_handled_by: "internal", human_review_required: true , sla_days: 3 },
      { title: "Monthly performance report (internal QA + forward to client)", sort_order: 11, default_handled_by: "internal", human_review_required: true , sla_days: 3 },
    ],
    "sitelaunch-template": [
