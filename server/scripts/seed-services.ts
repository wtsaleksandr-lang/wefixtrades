...
async function main() {
  ...
  const TASK_TEMPLATES: Record<string, Array<{
    ...
    "sitelaunch-template": [
      ...
      { title: "Populate template with onboarding content", sort_order: 4, default_handled_by: "automation", is_recurring: false , sla_days: 1 },
      { title: "Apply brand colors + logo", sort_order: 5, default_handled_by: "automation", is_recurring: false , sla_days: 1 },
      { title: "Add contact forms, CTAs & lead capture", sort_order: 6, default_handled_by: "automation", is_recurring: false , sla_days: 1 },
      { title: "On-page SEO (title, meta, schema)", sort_order: 7, default_handled_by: "automation", is_recurring: false , sla_days: 1 },
